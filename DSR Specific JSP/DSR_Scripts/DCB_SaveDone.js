...
function DCB_SaveDone(chkMandatory)
{
...
*/
	...
	if(chkMandatory==1){
		...
		/*if(objDataForm.DCI_CCRNNo.value==""){
			alert("Card CRN No is Mandatory");
			objDataForm.DCI_CCRNNo.focus();
			return false;
		}else if(!CheckDataType(objDataForm.DCI_CCRNNo.value,"Numeric")){
			alert("Invalid Data in Card CRN No Only Numerics are allowed");
			objDataForm.DCI_CCRNNo.focus();
			return false;
			
		}else if(objDataForm.DCI_CCRNNo.value.length < 9){
			alert("Card CRN No should be of nine digits");
			objDataForm.DCI_CCRNNo.focus();
			return false;
		}
		if(objDataForm.DCI_SC.value==""){
			alert("Source Code is Mandatory");
			objDataForm.DCI_SC.focus();
			return false;
		}else if(!CheckDataType(objDataForm.DCI_SC.value,"Numeric")){
			alert("Invalid Data in Source Code Only Numeric are allowed");
			objDataForm.DCI_SC.focus();
			return false;
		}else if(objDataForm.DCI_SC.value.length < 7){
			alert("Source Code should be of seven digits");
			objDataForm.DCI_SC.focus();
			return false;
		}*/
