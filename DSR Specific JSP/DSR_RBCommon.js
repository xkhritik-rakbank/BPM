...
var Date_Scripts="..\\webdesktop\\webtop\\scripts\\date.js"
var general="..\\webdesktop\\webtop\\scripts\\wdgeneral.js"
var generalvalidation="..\\webdesktop\\webtop\\scripts\\validation.js"
var constant_script="..\\webdesktop\\webtop\\en_us\\scripts\\wdconstants.js"
try
{
...
if ((processname=='DSR_Common'))
{
	
if (e.name.toUpperCase()=='DCI_CCRNNO'){
	re=RECommon('numeric')
  if(re.test(e.value)){
...
if (e.name.toUpperCase()=='DCI_EXTNO'){
	re=RECommon('numeric')
 if(re.test(e.value)){
   e.value = e.value.replace(re, "");
  }
