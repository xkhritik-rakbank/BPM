...
function RemovePendingOptionsCR(dropdownfieldId,selectedValueId)
{
	...
	if(selectedValueId=='PODOptionsSelecetedCR'){
		//saveSelectedMultiValueField('PODOptionsSeleceted','wdesk:PODOptions');
		var sDropdown = document.getElementById('PendingOptionsSelectedCR');
		var sDropDownValue = "";
		var opt = [], tempStr = "";
...
<input type='text' name='Header' readOnly size='24' style='display:none' value='Card Replacement'>
	...
	<TR>	    
        ...
        <td nowrap  width="150" colspan=3><textarea name="oth_cr_RR" type="text" cols=50 onKeyup="CheckMxLength(this,500);" rows=5><%=DataFormHT!=null&&DataFormHT.get("oth_cr_RR")!=null?DataFormHT.get("oth_cr_RR"):""%></textarea></td>
	</tr>	
	<TR>
		<td nowrap width="140" height="30" class="EWLabelRB"  id="DSR_ODC_RR_PF">Pending For</td>
        <td>
					<table>
					<tr>
