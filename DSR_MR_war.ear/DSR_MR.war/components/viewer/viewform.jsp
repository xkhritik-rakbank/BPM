...
//                        userEmailId = wdmodel.getM_objGeneralData().getM_strUserEmailId();
    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
		...
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_RBCommon.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_MR_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_MR_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_MR_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_MR_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_MR_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_MR/CustomJS/DSR_MR.js?rid=<%= randomId%>"></script>
