...
<head>
	<link href="/DSR_MR/components/viewer/resources/en_us/css/docstyle.css" rel="stylesheet" type="text/css"/>
...
<table id=tbl width="100%"   cellpadding=0 cellspacing=0>
	<tr width="100%">
		...
		<td colspan=1 align=left width="10%" >
			<img src='\DSR_MR\components\viewer\resources\images\rak-logo.gif'>
		</td>
	</tr>
</table>
<form name="dataform">
...
<script language="javascript" src="/DSR_MR/DSR_MR/CustomJS/DSR_RBCommon.js"></script>
<br>
...
<!-- 
	...
	Change History  :
    	                  Problem No        Function Name	changed on	  changed by
    	                  --------------    -------------	-----------	  ------------
						RBC/CR/1.0.1/086					04/05/2009	 Saurabh Arora
-->
