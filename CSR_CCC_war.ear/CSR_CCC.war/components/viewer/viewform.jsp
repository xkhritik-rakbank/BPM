    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_CCC_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_CCC_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_CCC_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_CCC_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_CCC_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_CCC.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCC/CustomJS/CSR_RBCommon.js?rid=<%= randomId%>"></script>
