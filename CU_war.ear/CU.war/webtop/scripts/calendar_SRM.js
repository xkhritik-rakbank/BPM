...
function calendarfn(obj_target) {
	...
	//alert("cal_gen_time1"+cal_gen_time1);
...
//alert("here3");
	if (str_datetime) {
		...
		//alert("this.dt_current"+this.dt_current);
		this.dt_selected = this.dt_current;
	}
	if (!this.dt_current) return;

	var obj_calwindow = window.open(
		'/CU/webtop/scripts/calendar_SRM.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id, //
...
function cal_popup2 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'/CU/webtop/scripts/calendar_SRM_DT.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=200,height='+(this.time_comp ? 215 : 190)+
		',status=no,resizable=no,top=200,left=200,dependent=yes,alwaysRaised=yes'
	);
	obj_calwindow.opener = window;
...
//alert("cal_gen_tsmp1 this.gen_date(dt_datetime) + ' ' + this.gen_time(dt_datetime)"+this.gen_date(dt_datetime) +" "+ this.gen_time(dt_datetime));
	return(this.gen_date(dt_datetime) + ' ' + this.gen_time(dt_datetime));
}

// date generating function
function cal_gen_date1 (dt_datetime) {
	//alert("In cal_gen_date1() dt_datetime.getDate()+dt_datetime.getMonth()+dt_datetime.getFullYear() "+dt_datetime.getDate()+" "+dt_datetime.getMonth()+" "+dt_datetime.getFullYear());
	return (
...
function cal_gen_time1 (dt_datetime) {
	...
	//alert("In cal_gen_time1() dt_datetime.getHours()+dt_datetime.getMinutes()+dt_datetime.getSeconds() "+dt_datetime.getHours()+" "+dt_datetime.getMinutes()+" "+dt_datetime.getSeconds());
	return (
...
function cal_prs_time1 (str_time, dt_date) {
	...
	//alert("str_time,dt_date "+str_time+" "+dt_date);
	//alert("dt_date.getHours "+dt_date.getHours());
...
//	if((Year1 > Year2) || ((Year1 == Year2) && (Month1 > Month2)) || ((Year1 == Year2) && (Month1 == Month2) && (Day1 > Day2)) || ((Year1 == Year2) && (Month1 == Month2) && (Day1 == Day2) && (Hour1 > Hour2)) || ((Year1 == Year2) && (Month1 == Month2) && (Day1 == Day2) && (Hour1 == Hour2) && (Min1 == Min2)) || ((Year1 == Year2) && (Month1 == Month2) && (Day1 == Day2) && (Hour1 == Hour2) && (Min1 == Min2) && (Sec1 == Sec2) ) )
