...
var passPhrase = "THISISASECRETKEY";

function Encrypt(plainText)
{
	//plainText="0000000000000000";
	//alert("encrypt 0000000000000000");
	var aesUtil = new AesUtil(keySize, iterationCount);
	var encrypt = aesUtil.encrypt(salt, iv, passPhrase, plainText);
	//alert("encrypt val:"+encrypt);
	
	//alert("decrypt :"+ encrypt);
	//alert("decrypt val:"+ Decrypt(encrypt));
...
{
	//alert("aes : "+plainText);
	//plainText='4NrdXHmIsnWmyqPk/ F5dEaLFVJFd9aC3gI9m9z66NU=';
	var aesUtil = new AesUtil(keySize, iterationCount);

	var test=plainText;
	var decrypt = aesUtil.decrypt(salt, iv, passPhrase, test);
	//alert("aes  val: "+decrypt);
	return decrypt;	    
}