...
<HTML>
		...
		<script language="JavaScript">
			...
			function HistoryCaller(){
				...
				if (window.showModalDialog){
					window.showModalDialog("../TL_Specific/history.jsp?WINAME="+WINAME,"", "dialogWidth:60; dialogHeight:400px; center:yes;edge:raised; help:no; resizable:no; scroll:yes;scrollbar:yes; status:no; statusbar:no; toolbar:no; menubar:no; addressbar:no; titlebar:no;");
				} else {
			...
			{		
				...
				{						
					...
					*/			
					if(dropdown.value=="Profile Change" && (document.getElementById("wdesk:Supporting_Docs").value=='' || document.getElementById("wdesk:Supporting_Docs").value==null)) {
						alert("You can select the documents, required for Profile change.");
					}
					if(dropdown.value=='Profile Change'){
					//alert("Decision ::::::::: " + Decision);
						document.getElementById("wdesk:MemoPad").value = 'Renewed Trade License Received but supporting document pending.';
						document.getElementById("MemoPads").value = 'Renewed Trade License Received but supporting document pending.';
					}
					else
					{
			...
			function getCustomerSummary()
			{
				...
				alert("Problem in customerSummary.jsp");
				return false;
				}		
				return true;
			}
	...
	<BODY onload="window.parent.checkIsFormLoaded();setFrameSize();initForm('<%=WSNAME%>','<%=wdmodel.getViewMode()%>');" id="frmData">
		<form name="wdesk" id="wdesk" method="post">
			...
			<div class="accordion-group">
				...
				<input type="hidden" name="cmreg_num" maxlength = '100' id="wdesk:cmreg_num"  readonly DISABLED=true value='<%=((WorkdeskAttribute)attributeMap.get("cmreg_num")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("cmreg_num")).getValue()%>'  >
				<!-- OPS_Checker starts -->
			...
			<div id="panel19" class="accordion-body collapse in">
				<div class="accordion-inner">
					<table id="TAB_TradeLicense" border='1' cellspacing='1' cellpadding='0' width="100%" >
						...
						<tr>
							<td nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
							<td style="text-align:right;" nowrap='nowrap' class='EWNormalGreenGeneral1'><input name='Fetch' type='button' id='Fetch' value='Search' onclick="GetSearchDetails();" class='EWButtonRB' <%=strDisableReadOnly%> style='width:85px' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td style="text-align:left;" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;&nbsp;&nbsp;<input name='Clear' id='Clear' type='button' value='Clear' onclick="ClearFields()" class='EWButtonRB' <%=strDisableReadOnly%> style='width:85px' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name='GetOLDTL' id='GetOLDTL' type='button' value='Get Old TL' onclick="GetPreviousYrTL()" class='EWButtonRB' <%=strDisableReadOnly%> style='width:85px' ></td>
							<td nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
						</tr>
					</table>
				</div>
							...
							<table id="TAB_SupportingDocs" border='1' cellspacing='1' cellpadding='0' width="100%" >
								<tr width="100%">
									...
									<td style="text-align:left; width: 45%;" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<p><b>List of Selected Documents</b></p>
										<div id='divSelectedList' style="OVERFLOW: auto;WIDTH: 304px;HEIGHT: 147px" onscroll="OnDivScroll(this.id);" >
											<select multiple size="8" id="selectedList" name="ToLB" style="width:auto;">
											</select>
										</div>
									</td>
								</tr>
						...
						<div class="accordion-inner">
							<table id="TAB_DecisionDetails" border='1' cellspacing='1' cellpadding='0' width=100% >
								...
								<tr>
									...
									<td width="23%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Memopads</td>
									<td nowrap='nowrap' class='EWNormalGreenGeneral1' width="24%">
										<textarea id ="MemoPads" name ="MemoPads" disabled style="width: 100%;"  rows="5" cols="50"><%=((WorkdeskAttribute)attributeMap.get("MemoPad")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("MemoPad")).getValue()%></textarea>
									</td>
								</tr>
							</table>
						</div>
