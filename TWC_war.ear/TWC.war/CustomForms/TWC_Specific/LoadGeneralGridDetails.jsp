...
<%
	...
	try{
		...
		logger.info("\n wiName "+wiName);
		String table_name="USR_0_TWC_General_DTLS_GRID";
		logger.info("table_name "+table_name);
		
		String col_Names="General_Conditions";
		...
		Query2 = "SELECT "+col_Names+" FROM "+ table_name+" with (nolock) WHERE WINAME=:WI_NAME order by GENERAL_SR_NO";
