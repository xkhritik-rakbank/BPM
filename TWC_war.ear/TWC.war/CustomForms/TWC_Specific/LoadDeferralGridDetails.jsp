...
<%
	...
	try{
		...
		logger.info("\n wiName "+wiName);
		String table_name="USR_0_TWC_DEFERRAL_DTLS_GRID";
		logger.info("table_name "+table_name);
		
		String col_Names="SR_NO,DOCUMENT_TYPE,APPROVING_AUTH_NAME,DEFERRAL_EXPIRY_DATE,REMARKS";
		...
		Query2 = "SELECT "+col_Names+" FROM "+ table_name+" with (nolock) WHERE WINAME=:WI_NAME order by SR_NO";
