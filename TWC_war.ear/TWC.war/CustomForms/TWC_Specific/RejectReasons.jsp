...
<%
	...
	if (workstename.equals("Credit_Hold"))
		workstename = "Credit_Document_Checker";
	if (workstename.equals("Sales_Hold"))
		workstename = "Sales_Reject";
	if (workstename.equals("CROPS_Archival") || workstename.equals("CROPS_Hold") || workstename.equals("CROPS_Deferral_Maker"))
		workstename = "CROPS_Admin_Checker";
	
	logger.info("Workstep name is "+workstename);
	
	if (workstename != null) {workstename=workstename.replace("'","");}
	
	Query="select item_code,Item_Desc from USR_0_TWC_ERROR_DESC_MASTER with(nolock) where isactive='Y' AND workstename=:workstename order by Display_Order ASC";
