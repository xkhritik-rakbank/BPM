...
<%
	...
	try{
		...
		logger.info("\n wiName "+wiName);
		String table_name="USR_0_TWC_UID_DTLS_GRID";
		logger.info("table_name "+table_name);
		
		String col_Names="UID_SR_NO,UID,REMARKS";
		...
		Query2 = "SELECT "+col_Names+" FROM "+ table_name+" with (nolock) WHERE WINAME=:WI_NAME order by UID_SR_NO";
