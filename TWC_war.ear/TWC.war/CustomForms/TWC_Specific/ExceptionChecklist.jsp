...
<%!
	...
	public String loadExceptions (String WINAME,String WSNAME,String segment,String H_CHECKLIST,String sessionId,String cabName,String ipAddr,int port,HashMap<String,String> canRaiseMap,HashMap<String,String> canClearMap,String userName)
	{
		...
		try{
			...
			String subXML ="";
			String Query = "select ExcpCode,WSName,UserName,Decision,ActionDateTime from USR_0_TWC_EXCEPTION_HISTORY where winame='"+WINAME+"' order by ExcpCode asc, cast(convert(varchar(24),actiondatetime+':000',113) as datetime) desc";
			...
			logger.info("outputXML selecting exceptions -- "+outputXML);
			...
			Query="Select Checklist_Item_Desc,Checklist_Item_Code,Routing_Unit_1_Branches,Routing_Unit_1_WM_SME,Approving_Unit from USR_0_TWC_CHECKLIST_MASTER where IsActive='Y' AND wsname='"+WSNAME+"' AND canView= 'Y' and processname='TWC' order by id Asc";
...
<%
	...
	String query="Select Checklist_Item_Desc,Checklist_Item_Code,Routing_Unit_1_Branches,Routing_Unit_1_WM_SME,Approving_Unit,canRaise,canClear from USR_0_TWC_CHECKLIST_MASTER where IsActive='Y' and wsname = '"+wsname+"' and canView= 'Y' and processname='TWC' order by id Asc";
