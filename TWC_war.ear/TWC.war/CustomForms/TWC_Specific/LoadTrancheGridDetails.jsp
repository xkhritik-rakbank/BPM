...
<%
	...
	try{
		...
		logger.info("\n wiName "+wiName);
		String table_name="USR_0_TWC_TRANCHE_DTLS_GRID";
		logger.info("table_name "+table_name);
		
		//Added on 03/04/2019. 3 New Columns added.
		String col_Names="TRANCHE_SR_NO,TRANCHE_AMOUNT,TRANCHE_STATUS,Available_Period,Disbursal_Date,Tranche_Remarks";
		...
		Query2 = "SELECT "+col_Names+" FROM "+ table_name+" with (nolock) WHERE WINAME=:WI_NAME order by TRANCHE_SR_NO";
