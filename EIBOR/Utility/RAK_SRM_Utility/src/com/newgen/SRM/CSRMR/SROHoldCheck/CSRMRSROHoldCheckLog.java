...
public final class CSRMRSROHoldCheckLog
{
	private static String loggerName = "CSRMRSROHoldCheckLogger";
    protected static org.apache.log4j.Logger CSRMRSROHoldCheckLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CSRMRSROHoldCheck_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CSRMRSROHoldCheck_Logs/"+logDateFormat.format(date)+"/CSRMRSROHoldCheck_Log.xml";
