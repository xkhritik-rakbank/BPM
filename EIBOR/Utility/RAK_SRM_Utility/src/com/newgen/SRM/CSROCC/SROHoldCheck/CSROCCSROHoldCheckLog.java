...
public final class CSROCCSROHoldCheckLog {
	private static String loggerName = "CSROCCSROHoldCheckLogger";
    protected static org.apache.log4j.Logger CSROCCSROHoldCheckLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CSROCCSROHoldCheck_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CSROCCSROHoldCheck_Logs/"+logDateFormat.format(date)+"/CSROCCSROHoldCheck_Log.xml";
