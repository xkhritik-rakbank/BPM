...
public final class DSRODCSROHoldCheckLog {
	private static String loggerName = "DSRODCSROHoldCheckLogger";
    protected static org.apache.log4j.Logger DSRODCSROHoldCheckLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DSRODCSROHoldCheck_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DSRODCSROHoldCheck_Logs/"+logDateFormat.format(date)+"/DSRODCSROHoldCheck_Log.xml";
