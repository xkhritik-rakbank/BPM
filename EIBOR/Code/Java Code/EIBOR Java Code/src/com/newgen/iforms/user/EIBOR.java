...
public class EIBOR implements IFormListenerFactory{

	private static String loggerName = "EIBOR_Logger";
	private static String processName = "EIBOR";
	...
	public static void setLogger() 
	{
		try 
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "CustomConfig"+ File.separator+"EIBOR"+ File.separator+ "log4j_EIBOR.properties"));
