...
<%
			...
			String ws_name_Esapi = ESAPI.encoder().encodeForSQL(new OracleCodec(), input1!=null?input1:"");
			WriteLog("Integration jsp: ws_name_Esapi: "+ws_name_Esapi);
			...
			WriteLog("Integration jsp: acc_num_new_Esapi: "+acc_num_new_Esapi);
...
function onloadclickMe(element) {
	...
	document.getElementById('if').src="/TF/CustomForms/TF_Specific/loadImages.jsp?debtAccNum="+debtAccNum;
}
