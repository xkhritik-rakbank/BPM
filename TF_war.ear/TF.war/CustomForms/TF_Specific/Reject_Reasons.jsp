...
<%
			...
			String worksteName_Esapi = ESAPI.encoder().encodeForSQL(new OracleCodec(), input5!=null?input5:"");
	...
	String subXML="";	
	String workstename = worksteName_Esapi;  //added by shamily to get workstepname
	if (workstename != null) {workstename=workstename.replace("'","''");}

	Query="select item_code,Item_Desc from usr_0_tf_error_desc_Master with(nolock) where isactive='Y' AND workstename=:workstename order by id ASC";
