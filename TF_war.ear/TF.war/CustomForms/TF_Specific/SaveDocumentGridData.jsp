...
<%
	...
	try
	{
			...
			"<TableName>USR_0_TF_SaveDocGridTable</TableName>" +
			...
			WriteLog("\nsInsert InputXML For DocGrid Data :"+sInputXML);
			
			String outputXML = WFCustomCallBroker.execute(sInputXML,sJtsIp,iJtsPort,1);
			WriteLog("\nInsert OutputXML For DocGrid Data :"+outputXML);
