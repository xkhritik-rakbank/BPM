                    ...
                    if (g.node.hasClass(s, "fr-marker")) n = (n + 1) % 2;
                        ...
                        if (0 < Ee(s).find(".fr-marker").length) n = e(Ee(s), n, r, i);
                            ...
                            for (var l = Ee(s).find(r || "*:not(br)"), d = l.length - 1; 0 <= d; d--) {
                                var c = l[d];
                                console.log(c), g.node.isBlock(c) || g.node.isVoid(c) || void 0 !== r && !p(c, f(r, i)) ? g.node.isBlock(c) && void 0 === r && "TABLE" != s.tagName && g.node.clearAttributes(c) : g.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML)
                            }
        ...
        function K(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (p.drag_support.formdata && (t = p.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function() {
                        L.call(a, u)
                    }, a.onerror = w, a.upload.onprogress = x, a.onabort = N, C(), p.events.disableBlur(), p.edit.off(), p.events.enableBlur();
