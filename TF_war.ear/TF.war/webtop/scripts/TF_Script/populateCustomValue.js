...
//window.document.write("<script src=\"/SRM_constants.js\"></script>");
//window.document.write("<script src=\"/TF/webtop/scripts/TF_Script/SRM_constants.js\"></script>");
window.document.write("<script language=\"javascript\" src=\"/TF/webtop/scripts/TF_Script/SRM_constants.js\"></script>");
...
function populateCustomValue(columnList,frameName,selGridModifyBundleID,CategoryID,SubCategoryID,sMode)
{
	...
	else if(CategoryID=='1' && SubCategoryID=='2')
	{
		...
		if(frameName == 'AUTHORIZATION DETAILS')
		{
			...
			if(document.getElementById('WS_NAME').value!='PBO' && document.getElementById('WS_NAME').value!='Q1' && document.getElementById('WS_NAME').value!='Q2')
			{
...
function ValidateDate()
{
	...
	if(CategoryID=='1' && (SubCategoryID=='2' || SubCategoryID=='4'))
	{
