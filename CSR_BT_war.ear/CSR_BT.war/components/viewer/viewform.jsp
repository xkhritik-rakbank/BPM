    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT_IntegrationEvents.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_BT/CustomJS/CSR_BT.js?rid=<%= randomId%>"></script>
