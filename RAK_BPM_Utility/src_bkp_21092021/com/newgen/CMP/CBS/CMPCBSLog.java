...
public final class CMPCBSLog
{
	private static String loggerName = "CMPCBSLogger";
    protected static org.apache.log4j.Logger CMPCBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CMP_CBS_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CMP_CBS_Logs/"+logDateFormat.format(date)+"/CMP_CBS_Log.xml";
