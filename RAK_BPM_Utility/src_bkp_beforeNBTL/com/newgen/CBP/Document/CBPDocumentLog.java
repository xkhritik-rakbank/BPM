...
public final class CBPDocumentLog 
{
	private static String loggerName = "CBPDocumentLogger";
    protected static org.apache.log4j.Logger CBPDocumentLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    {    	
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CBP_Document_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CBP_Document_Logs/"+logDateFormat.format(date)+"/CBP_Document_Log.xml";
