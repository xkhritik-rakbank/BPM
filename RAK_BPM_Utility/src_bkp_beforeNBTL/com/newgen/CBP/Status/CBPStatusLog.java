...
public class CBPStatusLog {
	
	private static String loggerName = "CBPStatusLogger";
    protected static org.apache.log4j.Logger CBPStatusLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CBP_Status_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CBP_Status_Logs/"+logDateFormat.format(date)+"/CBP_Status_Log.xml";
