...
public class CMPStatusLog {
	
	private static String loggerName = "CMPStatusLogger";
    protected static org.apache.log4j.Logger CMPStatusLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CMP_Status_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CMP_Status_Logs/"+logDateFormat.format(date)+"/CMP_Status_Log.xml";
