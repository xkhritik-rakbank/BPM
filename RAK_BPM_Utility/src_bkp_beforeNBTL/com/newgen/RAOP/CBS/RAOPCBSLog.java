...
public final class RAOPCBSLog
{
	private static String loggerName = "RAOPCBSLogger";
    protected static org.apache.log4j.Logger RAOPCBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "RAOP_CBS_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/RAOP_CBS_Logs/"+logDateFormat.format(date)+"/RAOP_CBS_Log.xml";
