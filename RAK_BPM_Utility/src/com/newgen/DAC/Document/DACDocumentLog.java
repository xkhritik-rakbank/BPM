...
public final class DACDocumentLog
{
	private static String loggerName = "DACDocumentLogger";
    protected static org.apache.log4j.Logger DACDocumentLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAC_Document_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAC_Document_Logs/"+logDateFormat.format(date)+"/DAC_Document_Log.xml";
