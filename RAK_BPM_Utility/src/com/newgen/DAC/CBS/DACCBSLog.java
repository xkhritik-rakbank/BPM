...
public final class DACCBSLog
{
	private static String loggerName = "DACCBSLogger";
    protected static org.apache.log4j.Logger DACCBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAC_CBS_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAC_CBS_Logs/"+logDateFormat.format(date)+"/DAC_CBS_Log.xml";
