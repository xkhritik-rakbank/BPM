...
import com.newgen.TAO.Integration.TAOSystemIntegration;
...
import com.newgen.NBTL.Document.NBTLDocument;
import com.newgen.NBTL.Hold.NBTLHold;
...
public class RAKBankUtility
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			if(mainPropMap.get("TAO_System_Integration")!=null && mainPropMap.get("TAO_System_Integration").equalsIgnoreCase("Y"))
			{
				Thread TAO_System_Integration = new Thread(new TAOSystemIntegration());
				TAO_System_Integration.start();
				System.out.println("TAO_System_Integration Started");
				MainLogger.info("TAO_System_Integration Started");
			}
			if(mainPropMap.get("NBTL_Document")!=null && mainPropMap.get("NBTL_Document").equalsIgnoreCase("Y"))
			{
				Thread NBTL_Document = new Thread(new NBTLDocument());
				NBTL_Document.start();
				System.out.println("NBTL_Document Started");
				MainLogger.info("NBTL_Document Started");
			}
			if(mainPropMap.get("NBTL_CBS")!=null && mainPropMap.get("NBTL_CBS").equalsIgnoreCase("Y"))
			{
				Thread NBTL_CBS = new Thread(new NBTLCBS());
				NBTL_CBS.start();
				System.out.println("NBTL_CBS Started");
				MainLogger.info("NBTL_CBS Started");
			}
			if(mainPropMap.get("NBTL_StatusUpdate")!=null && mainPropMap.get("NBTL_StatusUpdate").equalsIgnoreCase("Y"))
			{
				Thread NBTL_StatusUpdate = new Thread(new NBTL_StatusUpdate());
				NBTL_StatusUpdate.start();
				System.out.println("NBTL_StatusUpdate Started");
				MainLogger.info("NBTL_StatusUpdate Started");
			}
			if(mainPropMap.get("NBTLHold")!=null && mainPropMap.get("NBTLHold").equalsIgnoreCase("Y"))
			{
				Thread NBTLHold = new Thread(new NBTLHold());
				NBTLHold.start();
				System.out.println("NBTLHold Started");
				MainLogger.info("NBTLHold Started");
			}
		}
		catch (Exception e)
		{
