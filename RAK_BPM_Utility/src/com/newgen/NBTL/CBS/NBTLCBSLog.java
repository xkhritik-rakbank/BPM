...
public final class NBTLCBSLog
{
	private static String loggerName = "NBTLCBSLogger";
    protected static org.apache.log4j.Logger NBTLCBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "NBTL_CBS_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/NBTL_CBS_Logs/"+logDateFormat.format(date)+"/NBTL_CBS_Log.xml";
