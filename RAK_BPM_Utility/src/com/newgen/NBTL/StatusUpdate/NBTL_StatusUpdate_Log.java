...
public final class NBTL_StatusUpdate_Log {

	private static String loggerName = "NBTLStatusUpdateLogger";
    protected static org.apache.log4j.Logger NBTLStatusUpdateLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "NBTL_StatusUpdate_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/NBTL_StatusUpdate_Logs/"+logDateFormat.format(date)+"/NBTL_StatusUpdate_Log.xml";
