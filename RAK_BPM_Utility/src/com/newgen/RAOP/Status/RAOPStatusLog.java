...
public final class RAOPStatusLog
{
	private static String loggerName = "RAOPStatusLogger";
    protected static org.apache.log4j.Logger RAOPStatusLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "RAOP_Status_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/RAOP_Status_Logs/"+logDateFormat.format(date)+"/RAOP_Status_Log.xml";
