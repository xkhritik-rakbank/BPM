...
public final class CBPCBSLog
{
	private static String loggerName = "CBPCBSLogger";
    protected static org.apache.log4j.Logger CBPCBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "CBP_CBS_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/CBP_CBS_Logs/"+logDateFormat.format(date)+"/CBP_CBS_Log.xml";
