...
public class KYC_Remediation implements IFormListenerFactory{

	private static String loggerName = "KYC_RemediationLogger";
	private static String processName = "KYC_Remediation";
	...
	public static void setLogger() 
	{
		try 
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "CustomConfig"+ File.separator+"KYC_Remediation"+ File.separator+ "log4j_KYC_Remediation.properties"));
