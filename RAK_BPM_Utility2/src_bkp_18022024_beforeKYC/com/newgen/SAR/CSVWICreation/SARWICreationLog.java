...
public final class SARWICreationLog {

	
	private static String loggerName = "SARWICreationLogger";
    protected static org.apache.log4j.Logger SARWICreationLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "SARWICreation_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/SARWICreation_Logs/"+logDateFormat.format(date)+"/SARWICreation_log.xml";
