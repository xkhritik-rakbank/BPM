...
public final class CreateWIFromTextFileLog {
	
		private static String loggerName = "CreateWIFromTextFileLogger";
	    protected static org.apache.log4j.Logger CreateWIFromTextFileLogger = org.apache.log4j.Logger.getLogger(loggerName);
	    ...
	    protected static void setLogger()
	    {
	    	try
			{
				...
				p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "FPU_CreateWIFromTextFile_log4j.properties"));
				String dynamicLog = null;
				String orgFileName = null;
				File d = null;
				File fl = null;

				dynamicLog = "Logs/FPU_CreateWIFromTextFile_Logs/"+logDateFormat.format(date)+"/FPU_CreateWIFromTextFile_log.xml";
