...
public final class TWC_CP_Logs {

	
	private static String loggerName = "TWC_CP_Logger";
    protected static org.apache.log4j.Logger TWC_CP_Logger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "TWC_CP_Logger_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/TWC_CP_Logger_Logs/"+logDateFormat.format(date)+"/TWC_CP_Logger_log.xml";
