...
public final class SMEsoukDocArchivalLog {
	


	
	private static String loggerName = "DocArchivalLogger";
    protected static org.apache.log4j.Logger DocArchivalLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "SMEsoukDocArchival_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/SMEsoukDocArchival_Logs/"+logDateFormat.format(date)+"/SMEsoukDocArchival_log.xml";
