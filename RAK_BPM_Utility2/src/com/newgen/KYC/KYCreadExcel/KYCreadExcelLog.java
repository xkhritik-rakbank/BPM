...
public final class KYCreadExcelLog {
	
		private static String loggerName = "KYCreadExcelLogger";
	    protected static org.apache.log4j.Logger KYCreadExcelLogger = org.apache.log4j.Logger.getLogger(loggerName);
	    ...
	    protected static void setLogger()
	    {
	    	try
			{
				...
				p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "KYC_ReadExcelFile_log4j.properties"));
				String dynamicLog = null;
				String orgFileName = null;
				File d = null;
				File fl = null;

				dynamicLog = "Logs/KYC_KYCreadExcel_Logs/"+logDateFormat.format(date)+"/KYC_KYCreadExcel_log.xml";
