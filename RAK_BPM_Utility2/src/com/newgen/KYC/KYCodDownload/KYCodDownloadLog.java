...
public final class KYCodDownloadLog {
	
		
		private static String loggerName = "KYCodDownloadLogger";
	    protected static org.apache.log4j.Logger KYCodDownloadLogger = org.apache.log4j.Logger.getLogger(loggerName);
	    ...
	    protected static void setLogger()
	    {
	    	try
			{
				...
				p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "KYC_OddDownload_log4j.properties"));
				String dynamicLog = null;
				String orgFileName = null;
				File d = null;
				File fl = null;

				dynamicLog = "Logs/KYC_KYCodDownload_Logs/"+logDateFormat.format(date)+"/KYC_KYCodDownload_log.xml";
