...
import com.newgen.KYC.KYCodDownload.KYCodDownload;
import com.newgen.KYC.KYCreadExcel.KYCreadExcel;
...
public class RAK_BPM_Utility2
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			if(mainPropMap.get("KYCreadExcel")!=null && mainPropMap.get("KYCreadExcel").equalsIgnoreCase("Y"))
			{
				System.out.println("Going To start KYCRead Utility..");
				Thread KYCreadExcel = new Thread(new KYCreadExcel());
				System.out.println("KYCRead thread initiallized..");
				KYCreadExcel.start();
				System.out.println("KYCRead Utility Started");
				MainLogger.info("KYCRead Utility Started");
			}	
			if(mainPropMap.get("KYCodDownload")!=null && mainPropMap.get("KYCodDownload").equalsIgnoreCase("Y"))
			{
				System.out.println("Going To start KYCodDownload Utility..");
				Thread KYCodDownload = new Thread(new KYCodDownload());
				System.out.println("KYCodDownload thread initiallized..");
				KYCodDownload.start();
				System.out.println("KYCodDownload Utility Started");
				MainLogger.info("KYCodDownload Utility Started");
			}
