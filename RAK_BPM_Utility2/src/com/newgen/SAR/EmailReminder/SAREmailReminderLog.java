...
public class SAREmailReminderLog {


	
	private static String loggerName = "EmailReminderLogger";
    protected static org.apache.log4j.Logger EmailReminderLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "SAREmailReminder_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/SAREmailReminder_Logs/"+logDateFormat.format(date)+"/SAREmailReminder_log.xml";
