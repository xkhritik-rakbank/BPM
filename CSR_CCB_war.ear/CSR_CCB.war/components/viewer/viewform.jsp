    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_RBCommon.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_CCB_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_CCB_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_CCB_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_CCB_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_CCB_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_CCB/CustomJS/CSR_CCB.js?rid=<%= randomId%>"></script>
