...
<HTML>
<HEAD>
<TITLE> <%=WINAME%>: Decision History</TITLE>
...
<%	
	...
	//String WINAME = ESAPI.encoder().encodeForSQL(new OracleCodec(), input2!=null?input1:"");
	if (WINAME != null) {WINAME=WINAME.replace("'","''");}
	String hist_table = "USR_0_SRB_WIHISTORY";
	String colname="";
	String colvalues="'";
	String strQuery="";
	String strInputXML="";
	...
	strQuery="select item_code,Item_Desc from USR_0_SRB_Error_Desc_Master with(nolock) where isactive=:isactive order by id asc";
	params = "isactive==Y";
...
<%
		...
		{	
			...
			wsname = objWorkList.getVal("actual_wsname");
