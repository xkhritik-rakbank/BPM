...
<script language="javascript" src="/SRB/webtop/scripts/SRB_Scripts/keyPressValidation.js"></script>
<script language="javascript" src="/SRB/webtop/scripts/SRB_Scripts/formLoad_SRB.js?"></script>
<script language="javascript" src="/SRB/webtop/scripts/SRB_Scripts/populateCustomValue.js"></script>
<script language="JavaScript" src="/SRB/webtop/scripts/SRB_Scripts/calendar_SRB.js"></script>
<script language="javascript" src="/SRB/webtop/scripts/SRB_Scripts/json3.min.js"></script>
<script language="javascript" src="/SRB/webtop/scripts/clientSRB.js"></script>
<script language="javascript" src="/SRB/webtop/scripts/SRB_Scripts/Validation_SRB.js"></script>
<!DOCTYPE html> 
<HTML>
<Head>	
...
<script type="text/javascript">
	...
	//In this function Write Custom Validation and code	required on page load, populateCustomValue.js;
		...
		//alert(document.getElementById("SubCategoryID").value);
		...
		if(parent.document.getElementById("wdesk:IntegrationStatus").value=='false' && parent.document.getElementById("wdesk:WS_NAME").value=='Introduction' )
			disableFieldsOnIntroReload();
			
		//call to set first radio in the grid on form load
		var sMode = document.getElementById("sMode").value;
		if(parent.document.getElementById("wdesk:WS_NAME").value!='Introduction'||parent.document.getElementById("wdesk:WS_NAME").value!='CM_Introduction')
		{
	...
	function setPrimaryField()
	{
		...
		if((SubCategoryID=='4' || SubCategoryID=='2') && wsname!="Introduction")
	...
	function islamicval() // what's need to call this ?
	{
		parent.islamicval();
	}	
	...
	function getwiname() // what's need to call this ?
	{
		parent.getwiname(); 
	}
	...
	{
		parent.validateStatementDate(field,value,Object); 
	}
...
{	
	...
	for(List<String> recordList: frameList)
	{
		...
		if(IsRepeatable.equals("Y"))
		{
			...
			if(sMode.equals("R") || !Workstep.equals("Introduction"))
			{
			...
			//WriteLog("gggggggggggggggggguuuuuuuuuuuuuuuuuuuuuu"+FrameColumnListMap);	
			...
			if(Workstep.equals("Introduction") ||  Workstep.equals("Introduction"))
			{
	...
	{
		if(Workstep.equals("Introduction")||Workstep.equals("CM_Introduction"))
		{
...
public StringBuilder prepareGridDataRows(List <String> recordList,String firstRecordLabelName,List<Map> cardDetailList, String SubCategoryID,String FlagValue ,String sMode , String IP,int port,String cabName,String sessionID, String Workstep)
{
	...
	for(Map<String,String> map: cardDetailList)
	{
		...
		bundledColumnValue="";		
			...
			{
				html.append("<tr>");
				if (Workstep.equals("Introduction")){
	...
	html.append("<input type= 'hidden' id='"+firstRecordLabelName+"_"+SubCategoryID+"_gridselrowindex'  id='"+firstRecordLabelName+"_"+SubCategoryID+"_gridselrowindex' value= '' />");
			...
			{	
				...
				else if(!FieldOrder.equals("1"))
				{
					...
					{ 
						...
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("1") && SubCategoryID.equals("23")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Preferential Rate/Fee Waiver" request added on 03/01/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("2") && SubCategoryID.equals("45")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Other - Financial Services" request added on 30/08/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("1") && SubCategoryID.equals("139")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Other - Non -Financial Services" request added on 30/08/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("2") && SubCategoryID.equals("140")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Other - Card Settlement" request added on 30/08/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("3") && SubCategoryID.equals("141")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Other - Card Maintenance" request added on 30/08/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("4") && SubCategoryID.equals("142")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Other - Card Dispatch" request added on 30/08/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("5") && SubCategoryID.equals("143")){
							html.append("<TR style='display:none'>");
						}
						// below condition added to make AccountNumber field disply none for "Other - Loan Services" request added on 30/08/2018
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("6") && SubCategoryID.equals("144")){
						html.append("<TR style='display:none'>");
						}
						//*********************
						
						// below condition added to make AccountNumber field disply none for "Consent" request added on 12/12/2021
						if(!FieldType.equals("H") && WS_NAME.equalsIgnoreCase("Introduction") && ColumnName.equalsIgnoreCase("AccountNumber") && CategoryID.equals("2") && SubCategoryID.equals("175")){
							html.append("<TR style='display:none'>");
						}
					...
					else if(FieldType.equals("T") )
					{
						...
						if(is_special.equals("SP_"))
							...
							else
							{
								...
								if (ColumnName.equalsIgnoreCase("CreditCardNumber"))
								{
									WriteLog("ColumnValue before Decrypt: "+ColumnValue);
									if (!ColumnValue.equalsIgnoreCase("") && ColumnValue != null)
									{
										if (ColumnValue.length() > 16)
										{	
											ColumnValue = decrypt(ColumnValue);
										}
					...
					{ 	
							...
							else
							{
								...
								{
									WriteLog("Going to populate dropdown values when data not found in combos table");
									WriteLog("ColumnName P: "+ColumnName);
					...
					else  if(FieldType.equals("D"))
					{
							...
							else
							{
								if(Editable.equals("N") || (sMode !=null && sMode.equalsIgnoreCase("R")))
								{
									if(map.isEmpty())
									{
										html.append("<td  width='"+intWidth+"%' nowrap='' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '' readonly disabled='disabled' "+event_function+"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0' ></td>");
									}
									else
									{
										if(map.containsKey(ColumnName))
										{		
											...
											if(!IsRepeatable.equals("Y"))
											html.append("<td  width='"+intWidth+"%' nowrap='' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '"+str+"' readonly disabled='disabled' "+event_function+"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0'></td>");
											else
											html.append("<td  width='"+intWidth+"%' nowrap='' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '' readonly disabled='disabled' "+event_function+"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0'></td>");
										}
										else{
											html.append("<td  width='"+intWidth+"%' nowrap='nowrap' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '' readonly disabled='disabled' "+event_function+"><a href='1' onclick ='' ><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0' ></a></td>");
											}
								...
								else
								{
									if(map.isEmpty())
									{
										html.append("<td  width='"+intWidth+"%' nowrap='nowrap' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '' readonly  "+event_function+"><a href='' onclick = \"initialize('"+SubCategoryID+"_"+ColumnName+"');return false;\" target=\"_blank\"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0' alt='' ></a></td>");
									}
									else
									{
										if(map.containsKey(ColumnName))
					...
					{ 		
							...
							if(is_special.equals("SP_"))
							{
								...
								if(Editable.equals("N") || (sMode !=null && sMode.equalsIgnoreCase("R")))
								{
									if(map.isEmpty())
									{
										html.append("<td  width='"+intWidth+"%' nowrap='nowrap' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '' readonly disabled='disabled' "+event_function+"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0' ></td>");
									}
									else
									{
										if(map.containsKey(ColumnName))
										{	
											if(map.size()!=0  && map.get(ColumnName)!=null && ((map.get(ColumnName)).lastIndexOf("$")>-1) && ((String)map.get(ColumnName)).substring(0,((String)map.get(ColumnName)).lastIndexOf("$")).equals(Workstep))
											{
											html.append("<td  width='"+intWidth+"%' nowrap='nowrap' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '"+((String)map.get(ColumnName)).substring(((String)map.get(ColumnName)).lastIndexOf("$")+1)+"' readonly disabled='disabled' "+event_function+"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0'></td>");
											}
											else{
											html.append("<td  width='"+intWidth+"%' nowrap='nowrap' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align = 'left' maxlength='"+FieldLength+"' value = '' readonly disabled='disabled' "+event_function+"><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0'></td>");
											}
								...
								else
								{
									...
									else
									{
										...
										{	
											...
											{
											html.append("<td width='"+intWidth+"%'  nowrap='nowrap' class='EWNormalGreenGeneral1'><input type='text' size = '22' name='"+nameFormElement+"' id='"+SubCategoryID+"_"+ColumnName+"' align ='left' maxlength='"+FieldLength+"' value = '' "+event_function+" ><a href='' onclick = \"initialize_DT('"+SubCategoryID+"_"+ColumnName+"');return false;\" target=\"_blank\" ><img src='/SRB/webtop/images/images/cal.gif' width='16' height='16' border='0' alt='' ></a></td>");
											}
									}	
...
<%
	...
	String input2 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("WS"), 1000, true) );    
	String WS = ESAPI.encoder().encodeForSQL(new OracleCodec(), input2!=null?input2:"");
	if (WS != null) {WS=WS.replace("'","''");}
	//String FlagValue=request.getParameter("FlagValue");
	String input3 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("FlagValue"), 1000, true) );    
	String FlagValue = ESAPI.encoder().encodeForSQL(new OracleCodec(), input3!=null?input3:"");
	if (FlagValue != null) {FlagValue=FlagValue.replace("'","''");}
	//String WINAME=request.getParameter("WINAME");
	String input4 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("WINAME"), 1000, true) );    
	String WINAME = ESAPI.encoder().encodeForSQL(new OracleCodec(), input4!=null?input4:"");
	if (WINAME != null) {WINAME=WINAME.replace("'","''");}
	//String TEMPWINAME=request.getParameter("TEMPWINAME");
	String input5 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("TEMPWINAME"), 1000, true) );    
	String TEMPWINAME = ESAPI.encoder().encodeForSQL(new OracleCodec(), input5!=null?input5:"");
	...
	String sMode= ESAPI.encoder().encodeForSQL(new OracleCodec(), input7!=null?input7:"");
	...
	else
	{
		try
		{
			...
			String input8 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("Category"), 1000, true) );    
			String sCategory = ESAPI.encoder().encodeForSQL(new OracleCodec(), input8!=null?input8:"");
			if (sCategory != null) {
			...
			String input9 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("SubCategory"), 1000, true) );    
			String sSubCategory = ESAPI.encoder().encodeForSQL(new OracleCodec(), input9!=null?input9:"");
			if (sSubCategory != null) {
				sSubCategory=sSubCategory.replace("_"," ");
				}
			if (sSubCategory != null) {sSubCategory=sSubCategory.replace("'","''");}
			WriteLog("SubCategory : "+sSubCategory);
			
			//String ServiceRequestCode=request.getParameter("subCategoryCode");
			String input10 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("subCategoryCode"), 1000, true) );    
			...
			//WriteLog("TEMPWINAME :"+request.getParameter("TEMPWINAME"));
			...
			{	
				...
				String qry = "select comboid,Value, [KEY] as AssocVal from USR_0_SRB_Combos cmb with (nolock),usr_0_srb_category cat with (nolock),usr_0_srb_subcategory subcat with (nolock), USR_0_SRB_WORKSTEPS wrkstp with (nolock),usr_0_srb_Service svc with (nolock) where cat.CategoryIndex=cmb.CatIndex and subcat.SubCategoryIndex=cmb.SubCatIndex and upper(cat.CategoryName) =:CategoryName AND upper(subcat.Application_FormCode)=:Application_FormCode and subcat.parentcategoryindex=cat.CategoryIndex  and cmb.IsActive =:IsActive and upper(wrkstp.Workstep_Name)=:Workstep_Name and cmb.Ws_Name = wrkstp.Logical_Name and wrkstp.SR_ID=svc.SR_ID and svc.CatIndex=cat.CategoryIndex and svc.SubCatIndex=subcat.SubCategoryIndex ";
			...
			if(WS.equals("Introduction")&&FlagValue.equals("N"))	
			{	
								
				//PANno=request.getParameter("panNo");
				String input12 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("panNo"), 1000, true) );    
				PANno = ESAPI.encoder().encodeForSQL(new OracleCodec(), input12!=null?input12:"");
			...
			{	
				...
				{	
					...
					}catch(Exception e){WriteLog("Exception in getting values");e.printStackTrace();}
			...
			if(WS.equals("Introduction") || WS.equals("PBR"))
			...
			String docquery="select doctype from usr_0_srB_document doc,usr_0_srb_worksteps ws,usr_0_srb_subcategory scat where upper(ws.workstep_name) = :workstep_name and doc.workstep = ws.Workstep_Name and doc.IsMandatory=:IsMandatory and upper(scat.Application_FormCode) =:Application_FormCode and scat.Application_FormCode=doc.SR_ID";
