...
<%		
	...
	try 
	{
			String input1 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("option"), 1000, true) );    
			...
			if(option.equalsIgnoreCase("Generate_Acknowledgement")) 
			{
					...
					pdfTemplatePath = properties.getProperty("SRB_PDF_Acknowledgement");
			}//*********************************************************************************************************************************************			
			...
			BaseFont unicode=BaseFont.createFont("/ibm/IBM/WebSphere/AppServer/profiles/AppSrv01/installedApps/ant1casapps01Node01Cell/SRB_war.ear/SRB.war/PDFTemplates/template/arabtype.ttf",BaseFont.IDENTITY_H,BaseFont.EMBEDDED);		
