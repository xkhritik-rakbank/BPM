...
function cal_popup1 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'/SRB/webtop/scripts/SRB_Scripts/calendar_SRB.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id, //
...
function cal_popup2 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'/SRB/webtop/scripts/calendar_CAC_DT.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=200,height='+(this.time_comp ? 215 : 190)+
