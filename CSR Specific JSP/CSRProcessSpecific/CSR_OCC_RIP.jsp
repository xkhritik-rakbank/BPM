...
<%
String BranchOptions=request.getParameter("BranchOptions"); 
...
<!-- 
	...
	Module          :       Other Credit Card Requests
	File            :       CSR_OCC_RIP.jsp
	Purpose         :       Re-issue PIN: The options available as reasons for PIN re-issue has only 1 value – ‘PIN not received’. Another reason needs to be added - ‘PIN forgotten’.
	Author			:		Saurabh Arora
	Change History  :
    	                  Problem No        Function Name	changed on	  changed by
    	                  --------------    -------------	-----------	  ------------
						RBC/CR/1.0.1/035					23/09/2008	 Saurabh Arora
-->
