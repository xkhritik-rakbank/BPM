...
function RR_SaveDone(chkMandatory)
{
...
*/
		...
		if(chkMandatory==1&&objDataForm.RRD_RFC.options[objDataForm.RRD_RFC.selectedIndex].value=="")
			{
			alert("Reversal For is Mandatory");
			objDataForm.RRD_RFC.focus();
			return false;
			}
		if(chkMandatory==1&&objDataForm.RRD_RFC.options[objDataForm.RRD_RFC.selectedIndex].value.toUpperCase()=="OTHERS PLS. SPECIFY"&&objDataForm.RRD_RFC_OTH.value=="")
			{
			alert("Others (Pls. Specify) is Mandatory");
			objDataForm.RRD_RFC_OTH.disabled=false;
			objDataForm.RRD_RFC_OTH.focus();
			return false;
			}
		if(chkMandatory==1&&objDataForm.RRD_RR.value=="")
			{
			alert("Remarks/Reasons (if any). is Mandatory");
			objDataForm.RRD_RR.focus();
			return false;
			}
		if (objDataForm.RRD_RR.value.length>500)
			{
        ...
        objWI_Obj.attribute_list['RRD_RR'].value=objDataForm.RRD_RR.value;
		objWI_Obj.attribute_list['RRD_RR'].modified_flag=true;
       
	    objWI_Obj.attribute_list['RRD_RFC'].value=objDataForm.RRD_RFC.options[objDataForm.RRD_RFC.selectedIndex].value;
		objWI_Obj.attribute_list['RRD_RFC'].modified_flag=true;
