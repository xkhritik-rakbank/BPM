...
function MR_SaveDone(chkMandatory)
{
...
*/
		...
		if(objDataForm.VD_MoMaidN.checked==true){
			...
			/*if(chkMandatory==1&&objDataForm.VD_Oth.checked==true&&objDataForm.VD_OthSpe.value==""){
				...
				return false;
			}else if(objDataForm.VD_Oth.checked==true&&objDataForm.VD_OthSpe.value=="" && 				 !CheckDataType(objDataForm.VD_Oth.value,"character")){
