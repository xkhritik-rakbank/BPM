...
@REM Modify these variables to match your environment
	...
	set JTS_LIBPATH=lib
	set MYCLASSPATH=bin
	set LIBCLASSPATH=%JTS_LIBPATH%\iforms.jar;%JTS_LIBPATH%\json-simple-1.1.1.jar;%JTS_LIBPATH%\log4j-1.2.14.jar;%JTS_LIBPATH%\sun.misc.base64decoder.jar;%JTS_LIBPATH%\wfdesktop.jar
@REM ************************************************************************************************
...
@REM mqsocketserver jar
    %JAVA_HOME%\bin\jar -cvf %JARPATH%\PC.jar com\newgen\iforms\user\*.class    
	%JAVA_HOME%\bin\jar -uvf %JARPATH%\PC.jar ..\src\com\newgen\iforms\user\*.java
	pause
@REM ************************************************************************************************
