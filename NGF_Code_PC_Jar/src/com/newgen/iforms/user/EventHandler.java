...
public class EventHandler extends PCCommon  implements IFormServerEventHandler
{	
	...
	{	
		//PC.setLogger();
		PC.mLogger.info("Inside executeServerEvent() ak 107 ---control: " + control + "\nevent: " + event);
		...
		switch(event)
		{
			case "FORMLOAD": return new PC_FormLoad().formLoadEvent(iformObj,control,Stringdata);				
