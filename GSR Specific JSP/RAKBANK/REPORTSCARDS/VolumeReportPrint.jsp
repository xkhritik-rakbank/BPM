...
int count4sum=0;
String procName="SRM_CARDS_VOLUME_REPORT";//"SRMREPORT_DETAILS";
ArrayList rows = null;
String columnData = "";
int countBT=0;
int countCBR=0;
...
else
{
    ...
    response.setHeader("Content-Disposition","attachment;filename=" + "Cardsvolume"+".xls");
}
sCabname=wfsession.getEngineName();
sSessionId = wfsession.getSessionId();
sJtsIp = wfsession.getJtsIp();
		...
		if(rows!=null && rows.size()>0)
			  {
					...
					<table align='center' cellspacing="1" cellpadding='1' width="90%" border='1'>
						<tr>
							...
							<td width="5%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>Elite CustomerNo.</center></span></td>
