...
// getting data from request....
	...
	String input4 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("requestStatus", request.getParameter("requestStatus"), 1000, true) );
	String requestStatus = ESAPI.encoder().encodeForSQL(new OracleCodec(), input4!=null?input4:"");
	
	String input5 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("reportType", request.getParameter("reportType"), 1000, true) );
	String reportType = ESAPI.encoder().encodeForSQL(new OracleCodec(), input5!=null?input5:"");
...
String param="";
String param1="";
String procName="SRM_CARDS_VOLUME_REPORT";
String procName1="SRM_CARD_VOL_STATUS_REPORT";
...
<table border="0" cellspacing="1" width="90%" align="center">
  ...
  <tr>  
	<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CARDS VOLUME REPORT</center></td>
  </tr>
</table>
...
<TR>
	<td align='left' ><font class='EWLabel3' > &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <b>Request Type:&nbsp;</b>
		<select name="requestType" >
			<% if(reqType!=null && !reqType.equals("")){%>
			<option <%if(reqType.equals("Card Service Request-Balance Transfer")){%> value='Card Service Request-Balance Transfer' selected <%}else{%> value='Card Service Request-Balance Transfer' <%}%> >Card Service Request-Balance Transfer</option>
			...
			<option  <%if(reqType.equals("Card Service Request-Credit Card Blocking Request")){%> value='Card Service Request-Credit Card Blocking Request' selected <%}else{%> value='Card Service Request-Credit Card Blocking Request' <%}%>  >Card Service Request-Credit Card Blocking Request</option>
			...
			<option  <%if(reqType.equals("Card Service Request-Miscellaneous Requests")){%> value='Card Service Request-Miscellaneous Requests' selected <%}else{%> value='Card Service Request-Miscellaneous Requests' <%}%>  >Card Service Request-Miscellaneous Requests</option>
			...
			<%} else { %>
				<option  value="Card Service Request-Balance Transfer" >Card Service Request-Balance Transfer</option>
				...
				<option  value="Card Service Request-Miscellaneous Requests" >Card Service Request-Miscellaneous Requests</option>
 ...
 -->
	...
	<font class='EWLabel3'><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Report Type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
		<select name="reportType" >
				<% if(repType!=null && reportType.equals("")){%>
...
<!-- 
 ...
 <td align='left' ><font class='EWLabel3' ><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Request Status:&nbsp;</b>
		<select name="requestStatus" >
				<% if(reqType!=null && !reqType.equals("")){%>
				<option <%if(reqStatus.equals("Branch_Approver")){%> value='Branch_Approver' selected <%}else{%> value='Branch_Approver' <%}%> >Branch Approver</option>
				...
				<option <%if(reqStatus.equals("")){%> value='' selected <%}else{%> value='' <%}%>  >All</option>
				<%} else { %>
...
try{
	...
	{
		//out.println("In Excption 1: "+e.toString());
		WriteLog("In Excption 1: "+e.toString());
	}
	int iRecd=0;
	if(rows!=null && rows.size()>0)
		  {
				...
				<table align='center' cellspacing="1" cellpadding='1' width="90%" border='1'>
					<tr>
						...
						<!-- changes according to BDB No.001 given by tanuj  -->
...
else if (repType.equals("Summarized"))
{
	try{
		...
		{
			//out.println("In Excption 2: "+e.toString());
			WriteLog("In Excption 2: "+e.toString());
		}
		int iRecd=0;
		if(rows!=null && rows.size()>0)
			  {
	...
	if (reqStatus.equals("CARDS"))
	{
		...
		if(rows1!=null && rows1.size()>0)
		{
			...
			for(int j=0;j<rows1.size();j++)
			{
				...
				if(reqType.equalsIgnoreCase("All")||tempReqType.equalsIgnoreCase("CSR_CBR"))
				{
					if (requestType1.equalsIgnoreCase("CSR_CBR"))
					{
				...
				if(reqType.equalsIgnoreCase("All")||tempReqType.equalsIgnoreCase("CSR_CCB"))
				{
					if (requestType1.equalsIgnoreCase("CSR_CCB"))
					{
						if (status1.equals("Complete"))
						{
							ccbExit = count1;
				...
				if(reqType.equalsIgnoreCase("All")||tempReqType.equalsIgnoreCase("CSR_MISC"))
				{
					if (requestType1.equalsIgnoreCase("CSR_MR"))
					{
						if (status1.equals("Complete"))
						{
							mrExit = count1;
				...
				{
					if (requestType1.equalsIgnoreCase("CSR_OCC"))
					{	
						if (status1.equals("Complete"))
						{
							occExit = count1;
			...
			%>
					<tr colspan="4">
						<td width="16%" class="EWSubHeaderText" ><center><B>Credit Card Blocking</B></center></td>
