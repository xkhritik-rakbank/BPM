...
<%
	...
	String type_1 = ESAPI.encoder().encodeForSQL(new OracleCodec(), input1!=null?input1:"");
...
int count4sum=0;
String procName="SRM_CSR_CARDS_BRRETURN_REPORT";//"SRMREPORT_DETAILS";
ArrayList rows = null;
String columnData = "";
int countBT=0;
int countCBR=0;
...
String tempfromdate="";
String temptodate = "";
String procName1="SRM_CSR_CARD_VOL_STATUS_REPORT999";
String param1="";
...
else
{
    ...
    response.setHeader("Content-Disposition","attachment;filename=" + "BranchReturn"+".xls");
}
/*sCabname=wfsession.getEngineName();
sSessionId = wfsession.getSessionId();
sJtsIp = wfsession.getJtsIp();
	...
	if(rows!=null && rows.size()>0)
		  {
			...
			<%try
			{
				...
				for(int j=0;j<rows.size();j++)
				{
					...
					//Commented below by Amandeep 5 Feb 2011
					//columnData = columnData.substring(columnData.indexOf("!")+1);
