...
String param="";
String param1="";
String procName="SRM_CSR_CARDS_BRRETURN_REPORT";//Detailed
String procName1="SRM_CSR_CARD_VOL_STATUS_REPORT999";//Summary
ArrayList rows = null;
...
try{
	if(reqType!=null && !reqType.equals("")){
		if(reqType.equalsIgnoreCase("Card Service Request-Credit Card Blocking Request")){
			...
			tempReqType="CSR_CCC";
		} else if(reqType.equalsIgnoreCase("Card Service Request-Other Credit Card Request")){
			tempReqType="CSR_OCC";
		} else if(reqType.equalsIgnoreCase("Card Service Request-Balanace Transfer")){
			tempReqType="CSR_BT";
		} else if(reqType.equalsIgnoreCase("Card Service Request-Cash Back Request")){
			tempReqType="CSR_CBR";
		} else if(reqType.equalsIgnoreCase("Card Service Request-Miscellaneous Request")){
			tempReqType="CSR_MR";
...
<title>BranchReturn Report</title>
...
function generate_Report()
{
	...
	document.FTOReport.action = "BranchReturnReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
function print_Report()
{
	...
	document.FTOReport.action = "BranchReturnReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
<table border="0" cellspacing="1" width="90%" align="center">
  ...
  <tr>  
	<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BRANCHRETURN REPORT</center></td>
  </tr>
</table>
...
<TR>
	<td align='left' ><font class='EWLabel3' > &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <b>Request Type:&nbsp;</b>
		<select name="requestType" >
			...
			<option  <%if(reqType.equals("Card Service Request-Other Credit Card Request")){%> value='Card Service Request-Other Credit Card Request' selected <%}else{%> value='Card Service Request-Other Credit Card Request' <%}%>  >Card Service Request-Other Credit Card Request</option>
			
			<option  <%if(reqType.equals("Card Service Request-Cash Back Request")){%> value='Card Service Request-Cash Back Request' selected <%}else{%> value='Card Service Request-Cash Back Request' <%}%>  >Card Service Request-Cash Back Request</option>
	
			<option  <%if(reqType.equals("Card Service Request-Balanace Transfer")){%> value='Card Service Request-Balanace Transfer' selected <%}else{%> value='Card Service Request-Balanace Transfer' <%}%>  >Card Service Request-Balanace Transfer</option>
		
			<option  <%if(reqType.equals("Card Service Request-Miscellaneous Request")){%> value='Card Service Request-Miscellaneous Request' selected <%}else{%> value='Card Service Request-Miscellaneous Request' <%}%>  >Card Service Request-Miscellaneous Request</option>
			...
			<%} else { %>
				...
				<option  value="Card Service Request-Other Credit Card Request" >Card Service Request-Other Credit Card Request</option>
				<option  value="Card Service Request-Cash Back Request" >Card Service Request-Cash Back Request</option>
				<option  value="Card Service Request-Balanace Transfer" >Card Service Request-Balanace Transfer</option>
				<option  value="Card Service Request-Miscellaneous Request" >Card Service Request-Miscellaneous Request</option>
	...
	if(rows!=null && rows.size()>0)
		  {
				...
				<table align='center' cellspacing="1" cellpadding='1' width="90%" border='1'>
					...
					<td width="8%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>Request Type</center></span></td>
						...
						<td width="9%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center> Introduced By</center></span></td>
						<td width="7%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>Initiation Branch</center></span></td>
						<td width="9%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>Introduction Date</center></span></td>
						<td width="7%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>Current Stage</center></span></td>
						<td width="7%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>Returned By</center></span></td>
						<td width="9%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>Decision Date After Resubmit</center></span></td>
						<td width="8%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>TeamLeader Decision After Resubmit</center></span></td>
					</tr>
			...
			<%try
			{
				...
				for(int j=0;j<rows.size();j++)
				{
					...
					columnData = columnData.substring(columnData.indexOf("!")+1);
					String tempRequestType3  = columnData.substring(0,columnData.indexOf("!"));
					columnData = columnData.substring(columnData.indexOf("!")+1);
					String CustomerName3= columnData.substring(0,columnData.indexOf("!"));
					columnData = columnData.substring(columnData.indexOf("!")+1);
					...
					if(tempRequestType.equalsIgnoreCase("All"))
					{
						...
						} else if((winame.substring(winame.lastIndexOf("-")+1)).equalsIgnoreCase("OCC")){
						...
						} else if((winame.substring(winame.lastIndexOf("-")+1)).equalsIgnoreCase("BT")){
					...
					if(tempRequestType.equalsIgnoreCase("CSR_CCB")){
						...
						countMR++;
						tempRequestType = "CSR - MiscellaneousRequests";
					}else if(tempRequestType.equalsIgnoreCase("CSR_BT")){
						countBT++;
						tempRequestType = "CSR - BalanceTransfer";
					}else if(tempRequestType.equalsIgnoreCase("CSR_CBR")){
						countCBR++;
						tempRequestType = "CSR - CashBackRequest";
						...
						<tr colspan=12>
							...
							<td width="10%" class="EWTableContentsNum" ><center><%=tempRequestType==null?"0":tempRequestType%> </center></td>
							...
							<td width="9%" class="EWTableContentsText" align='left'><%=winame2==null?"":winame2%></td>
							<td width="7%" class="EWTableContentsText" align='left'><%=winame12==null?"":winame12%></td>
							<td width="9%" class="EWTableContentsNum" ><center><%=tempRequestType2==null?"0":tempRequestType2%> </center></td>
							<td width="7%" class="EWTableContentsText" align='left'><%=CustomerName2==null?"0":CustomerName2%></td>
							<td width="7%" class="EWTableContentsNum" ><center><%=tempRequestType3==null?"0":tempRequestType3%> </center></td>
							<td width="9%" class="EWTableContentsText" align='left'><%=CustomerName3==null?"0":CustomerName3%></td>
							<td width="8%" class="EWTableContentsNum" ><%=CardNumber2==null?"0":CardNumber2%></td>
							</tr>
				<%
				}
			}
	...
	if(rows!=null && rows.size()>0)
		  {
			...
			<%try
			{
				...
				for(int j=0;j<rows.size();j++)
				{
					...
					columnData = columnData.substring(columnData.indexOf("!")+1);
					//Changed below by Amandeep 5 Feb 2011
					//String CustomerName= columnData.substring(0,columnData.indexOf("!"));
					String CustomerName= columnData;
					//out.println(CustomerName);
					//Commented Below By Amandeep 3 Feb 2011
					//CustomerName=CustomerName.replace("null","0");
					//Commnted below by Amandeep 5 Feb 2011
					//columnData = columnData.substring(columnData.indexOf("!")+1);
					//String CardNumber= columnData;
					//Commented above by Amandeep 5 Feb 2011
					//Commented Below By Amandeep 3 Feb 2011
					...
					if(tempRequestType.equalsIgnoreCase("CSR_CBR")){
						countCBR++;
						tempRequestType = "CSR - CashBackRequest";
