<%--
	...
	Module          :       Reports
	File            :       OCCReport.jsp
	Purpose         :       OCC Report on the lines of Card Volume Report
...
<%
	...
	String input6 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("requestType", request.getParameter("requestType"), 1000, true) );
	String requestType = ESAPI.encoder().encodeForSQL(new OracleCodec(), input6!=null?input6:"");
	...
	String tempReqType="";
	String param="";
	String procName="SRM_OCC_REPORT";
	ArrayList rows = null;
	String columnData = "";
	...
	String procName1="SRM_CARD_OCC_CARD_DECISION_REPORT";
...
<title>Other Credit Card Request Report</title>
...
function generate_Report()
{
	...
	document.FTOReport.action = "OccReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
function print_Report()
{
	...
	document.FTOReport.action = "OccReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
<table border="0" cellspacing="1" width="90%" align="center">
  ...
  <tr>  
	<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OTHER CREDIT CARD REQUEST REPORT</center></td>
  </tr>
</table>
...
try
{
	WriteLog("for csr_occ report,procName before: "+procName);
	WriteLog("for csr_occ report,param before: "+param);
	...
	WriteLog("for csr_occ report,sInputXML1: "+sInputXML1);
	...
	if(!sOutputXML1.equals("") || Integer.parseInt(sOutputXML1.substring(sOutputXML1.indexOf("<MainCode>")+10 , sOutputXML1.indexOf("</MainCode>")))==0)	{
		...
		WriteLog("rows, occ process report: "+rows.toString());
	}					
}
	catch(Exception e)
	{
	...
	try
	{
		WriteLog("procName1 before execution, occ process report: "+procName1);
		sInputXML1="<?xml version=\"1.0\"?>" + 				
					"<APProcedure2_Input>" +
					"<Option>APProcedure2</Option>" +
