...
//Description                : for denied volume Reports .
//------------------------------------------------------------------------------------------------------------------------------------>
...
String processdefID="";
String param="";
String procName="SRM_CARDS_DENIED_REPORT";
...
<title>Cards Denied Report</title>
...
function generate_Report()
{
	...
	document.FTOReport.action = "BRDeniedVolumeReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
function print_Report()
{
	...
	document.FTOReport.action = "DeniedVolumeReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
<table border="0" cellspacing="1" width="90%" align="center">
  ...
  <tr>  
	<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CARDS DENIED REPORT</center></td>
  </tr>
</table>
	...
	if(rows!=null && rows.size()>0)
		  {
				...
				<table align='center' cellspacing="1" cellpadding='1' width="90%" border='1'>
					<tr>
						...
						<!-- changes according to BDB 001 given by Tanuj -->
						...
						<td width="6%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>EliteCustomer No.</center></span></td>
