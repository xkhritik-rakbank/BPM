...
String processdefID="";
String param="";
String procName="SRM_CARDS_DENIED_REPORT_DSR";
...
function generate_Report()
{
	...
	document.FTOReport.action = "BRDeniedVolumeReportDSR.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
function print_Report()
{
	...
	document.FTOReport.action = "DeniedVolumeReportPrintDSR.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
