...
<html>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/>
		...
		function generate_Report()
		{
			...
			document.FTOReport.action = "CardSummaryReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
		...
		function print_Report()
		{
			...
			document.FTOReport.action = "CardSummaryReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
	...
	<body topmargin="0" marginheight="0" marginwidth="2" alink="blue" vlink="blue" leftmargin="0">
		...
		<table border="0" cellspacing="1" width="90%" align="center">
			...
			<tr>  
				<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CARD SUMMARY REPORT</center></td>
			</tr>
		</table>
