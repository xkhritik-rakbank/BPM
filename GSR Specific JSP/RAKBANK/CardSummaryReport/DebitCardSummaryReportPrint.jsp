...
<%
	...
	String input4 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("type", request.getParameter("type"), 1000, true) );
	String type_1 = ESAPI.encoder().encodeForSQL(new OracleCodec(), input4!=null?input4:"");
	WriteLog("Integration jsp: type_1: "+type_1);
	//WriteLog("Integration jsp: type_1: "+request.getParameter("type"));
...
/*
	...
	File            :       DebitCardSummaryReportPrint.jsp
