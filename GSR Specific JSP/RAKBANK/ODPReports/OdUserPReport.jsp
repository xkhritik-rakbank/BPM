...
<%
	...
	String param="";
	String procName="SRM_OD_USER_PRODUCTIVITY_REPORT";
	ArrayList rows = null;
	String columnData = "";
	...
	<head>
		...
		<script language='javascript'>
			...
			function generate_Report()
			{
				...
				document.FTOReport.action = "OdUserPReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
				+final_dt_to;
			...
			function print_Report()
			{
				...
				document.FTOReport.action = "OdUserPReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
	...
	<body topmargin="0" marginheight="0" marginwidth="2" alink="blue" vlink="blue" leftmargin="0">
		<form name='FTOReport' method='post' >
			...
			<table border="0" cellspacing="1" width="90%" align="center">
				...
				<tr>  
					<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Wise Productivity Report-Maker</center></td>
				</tr>
			</table>
