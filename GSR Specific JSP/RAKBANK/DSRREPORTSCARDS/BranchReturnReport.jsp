...
String param="";
String param1="";
String procName="SRM_DSR_CARDS_BRRETURN_REPORT";//Detailed
String procName1="SRM_DSR_BRRETURN_SUMMARY_REPORT";//Summary
ArrayList rows = null;
...
try{
	if(reqType!=null){
		if(reqType.equalsIgnoreCase("DebitCard Service Request-DebitCard Blocking Request")){
			tempReqType="DSR_DCB";
		} else if(reqType.equalsIgnoreCase("DebitCard Service Request-Miscellaneous Request")){
			tempReqType="DSR_MR";
		} else if(reqType.equalsIgnoreCase("DebitCard Service Request-Other DebitCard Request")){
			tempReqType="DSR_ODC";
...
<TR>
	<td align='left' ><font class='EWLabel3' > &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <b>Request Type:&nbsp;</b>
		<select name="requestType" >
			...
			<option  <%if(reqType.equals("DebitCard Service Request-DebitCard Blocking Request")){%> value='DebitCard Service Request-DebitCard Blocking Request' selected <%
			}else{%> value='DebitCard Service Request-DebitCard Blocking Request' <%}%>  >DebitCard Service Request-DebitCard Blocking Request</option>

			<option  <%if(reqType.equals("DebitCard Service Request-Miscellaneous Request")){%> value='DebitCard Service Request-Miscellaneous Request' selected <%}else{%> value='DebitCard Service Request-Miscellaneous Request' <%}%>  >DebitCard Service Request-Miscellaneous Request</option>
		
			<option  <%if(reqType.equals("DebitCard Service Request-Other DebitCard Request")){%> value='DebitCard Service Request-Other DebitCard Request' selected <%}else{%> value='DebitCard Service Request-Other DebitCard Request' <%}%>  >DebitCard Service Request-Other DebitCard Request</option>
			...
			<%} else { %>
				...
				<option  value="DebitCard Service Request-Miscellaneous Request" >DebitCard Service Request-Miscellaneous Request</option>
				<option  value="DebitCard Service Request-Other DebitCard Request" >DebitCard Service Request-Other DebitCard Request</option>
	...
	if(rows!=null && rows.size()>0)
		  {
				...
				<table align='center' cellspacing="1" cellpadding='1' width="90%" border='1'>
					...
					<td width="8%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>Request Type</center></span></td>
						...
						<td width="8%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>Master No</center></span></td>
			...
			<%try
			{
				...
				for(int j=0;j<rows.size();j++)
				{
					...
					{
						if((winame.substring(winame.lastIndexOf("-")+1)).equalsIgnoreCase("DCB")){
							...
							tempRequestType = "DSR_MR";
						} else if((winame.substring(winame.lastIndexOf("-")+1)).equalsIgnoreCase("ODC")){ 
					...
					if(tempRequestType.equalsIgnoreCase("DSR_DCB")){
						...
						countODC++;
						tempRequestType = "DSR - Other Debit Card Request";
					}else if(tempRequestType.equalsIgnoreCase("DSR_MR")){
						countMR++;
						tempRequestType = "DSR - MiscellaneousRequest";
					}	%>
