...
<%@ page import="java.text.*"%><%@ page import="org.owasp.esapi.ESAPI"%>
...
String procName1="SRM_DSR_CARD_VOL_STATUS_REPORT123";
...
function generate_Report()
{
	...
	document.FTOReport.action = "BRVolumeAdditionalReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
function print_Report()
{
	...
	document.FTOReport.action = "BRVolumeAdditionalReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
<table border="0" cellspacing="1" width="90%" align="center">
  ...
  <tr>  
	<td align="center" width="740" class="EWSubHeaderText" colspan='3'> <center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ADDITIONAL REPORT</center></td>
  </tr>
</table>
	...
	<td align='left' ><font class='EWLabel3' > &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <b>Request Type:&nbsp;</b>
		<select name="requestType" >
			...
			<%} else { %>
				...
				<option  value="DebitCard Service Request-Debit Card Blocking Request" >DebitCard Service Request-Debit Card Blocking Request</option>
...
<!-- 
 ...
 <td align='left' ><font class='EWLabel3' ><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Request Status:&nbsp;</b>
		<!--<select name="requestStatus" >
			...
			<input type="text" name="requestStatus" value="Branch_Approver" ReadOnly>
	</td>
</TR>
</table>
