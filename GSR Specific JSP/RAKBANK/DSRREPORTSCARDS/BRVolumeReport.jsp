...
//Description                : for Debit cards volume Reports .
//------------------------------------------------------------------------------------------------------------------------------------>
...
// getting data from request....
	...
	String input2 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("branchCode", request.getParameter("branchCode"), 1000, true) );
	String branchCode = ESAPI.encoder().encodeForSQL(new OracleCodec(), input2!=null?input2:"");
	WriteLog("Integration jsp: branchCode: "+branchCode);
	
	String input3 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("requestStatus", request.getParameter("requestStatus"), 1000, true) );
	String requestStatus = ESAPI.encoder().encodeForSQL(new OracleCodec(), input3!=null?input3:"");
	WriteLog("Integration jsp: requestStatus: "+requestStatus);
	
	String input4 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("reportType", request.getParameter("reportType"), 1000, true) );
	String reportType = ESAPI.encoder().encodeForSQL(new OracleCodec(), input4!=null?input4:"");
...
<TR>
	<td align='left' ><font class='EWLabel3' > &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <b>Request Type:&nbsp;</b>
		<select name="requestType" >
			<% if(reqType!=null && !reqType.equals("")){%>
			<!--<option <%if(reqType.equals("DebitCard Service Request-Balance Transfer")){%> value='Card Service Request-Balance Transfer' selected <%}else{%> value='Card Service Request-Balance Transfer' <%}%> >Card Service Request-Balance Transfer</option>-->
			...
			<!--<option  <%if(reqType.equals("DebitCard Service Request-Credit Card Cheque")){%> value='Card Service Request-Credit Card Cheque' selected <%}else{%> value='Card Service Request-Credit Card Cheque' <%}%>  >Card Service Request-Credit Card Cheque</option>-->
			...
			<!--<option  <%if(reqType.equals("DebitCard Service Request-Reversals Request")){%> value='Card Service Request-Reversals Request' selected <%}else{%> value='Card Service Request-Reversals Request' <%}%>  >Card Service Request-Reversals Request</option>-->
			...
			<%} else { %>
				<!--<option  value="DebitCard Service Request-Balance Transfer" >Card Service Request-Balance Transfer</option>-->
				...
				<!--<option  value="DebitCard Service Request-Credit Card Cheque" >Card Service Request-Credit Card Cheque</option>-->
				<option  value="DebitCard Service Request-Miscellaneous Requests" >DebitCard Service Request-Miscellaneous Requests</option>
				<!--<option  value="DebitCard Service Request-Reversals Request" >Card Service Request-Reversals Request</option>-->
...
<!-- 
 ...
 <td align='left' ><font class='EWLabel3' ><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Request Status:&nbsp;</b>
		<select name="requestStatus" >
				<% if(reqType!=null && !reqType.equals("")){%>
				<option <%if(reqStatus.equals("Branch_Approver")){%> value='Branch_Approver' selected <%}else{%> value='Branch_Approver' <%}%> >Branch Approver
				</option>

				<option  <%if(reqStatus.equalsIgnoreCase("CARDS")){%> value='CARDS' selected <%}else{%> value='CARDS' <%}%>  >Cards</option>
	...
	if(rows!=null && rows.size()>0)
		  {
				...
				<table align='center' cellspacing="1" cellpadding='1' width="90%" border='1'>
					<tr>
						...
						<td width="4%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>Master No.</center></span></td>
...
else if (repType.equals("Summarized"))
{
	...
	if (reqStatus.equalsIgnoreCase("CARDS"))
	{
		...
		{
			//out.println("In Exceptiontrtrt: "+e.toString());
		}
try{
