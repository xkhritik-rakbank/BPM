...
<html>
	<head>
		<link href="/omniflow/css/docstyle.css" rel="stylesheet" type="text/css">
		<title>Consolidated Report</title>
		<script language="JavaScript" src="/webtop/scripts/calendar1.js"></script>
		...
		function generate_Report()
		{
			...
			document.FTOReport.action = "ConsolidatedReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
		...
		function print_Report()
		{
			...
			document.FTOReport.action = "ConsolidatedReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
	...
	<body topmargin="0" marginheight="0" marginwidth="2" alink="blue" vlink="blue" leftmargin="0">
		...
		<table align='center' cellspacing="1" cellpadding='1' width="90%"> 
			<tr>
				...
				<input type="text box" name="dte_from" id='Date_dte_from' align = "left" maxlength="10" value = '<%=final_date_from==null?"":final_date_from%>' readonly><a href='1' onclick = "initialise('Date_dte_from');return false;" target='_parent' ><img src='/webtop/images/images/cal.gif' width='16' height='16' border='0' alt='Click here to pick up the date' ></a>&nbsp;&nbsp;&nbsp;
				</td>
			...
			<tr>
				...
				<input type="text box" name="dte_to" id='Date_dte_to' align = "left" maxlength="10" value = '<%=final_date_to==null?"":final_date_to%>' readonly><a href='1' onclick = "initialise('Date_dte_to');return false;" target='_parent' ><img src='/webtop/images/images/cal.gif' width='16' height='16' border='0' alt='Click here to pick up the date'></a>&nbsp;&nbsp;&nbsp;
				</td>
		...
		else
		{
			...
			%>
					...
					<td width="5%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>ECRN No.</center></span></td>
			...
			<%
					for(int j=0;j<rows.size();j++)
					{
						...
						columnData = columnData.substring(columnData.indexOf("!")+1);
						String ECRNNO= columnData.substring(0,columnData.indexOf("!"));
						columnData = columnData.substring(columnData.indexOf("!")+1);
			...
			%>
					<tr colspan=15>
						...
						<td width="4%" class="EWTableContentsText" align='left'><%=ECRNNO==null?"":ECRNNO%></td>
			...
			%>
					...
					<tr>
						...
						<td width="4%" height="25" class="EWSubHeaderText"><span class="EWLabel"><center>ECRN No.</center></span></td>
						...
						<td width="4%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>Deliver To</center></span></td>
			...
			%>
					<tr colspan=17>
						...
						<td width="6%" class="EWTableContentsText" align='left'><%=ECRNNO==null?"":ECRNNO%></td>
						...
						<td width="30%" class="EWTableContentsText" align='left'><%=CCCRemarks==null?"":CCCRemarks%></td>
					</tr>
			...
			%>
					...
					<tr>
						...
						<td width="12%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>ECRN No.</center></span></td>
			...
			%>
					<tr colspan=6>
						...
						<td width="12%" class="EWTableContentsText" align='left'><center><%=ECRNNO==null?"":ECRNNO%></center></td>
			...
			%>
					...
					<tr>
						...
						<td width="9%" height="21" class="EWSubHeaderText"><span class="EWLabel"><center>ECRN No.</center></span></td>
			...
			%>
					<tr colspan=6>
						...
						<td width="9%" class="EWTableContentsText" align='left'><center><%=ECRNNO==null?"":ECRNNO%></center></td>
