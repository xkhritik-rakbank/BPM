...
<%
	...
	try
	{
		if(reqType!=null && !reqType.equals(""))
		{
			...
			else if(reqType.equalsIgnoreCase("DebitCard BlockingRequest"))
			{
				tempReqType="DSR_DCB";
			}
...
<html>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/>
		...
		function generate_Report()
		{
			...
			document.FTOReport.action = "AgentReportDSR.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
		...
		function print_Report()
		{
			...
			document.FTOReport.action = "AgentReportPrintDSR.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
			...
			<TR>
				<td><font class='EWLabel3' >&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>&nbsp;&nbsp;&nbsp;&nbsp;Request Type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
					<select name="requestType" >
						...
						<option  <%if(reqType.equals("DebitCard BlockingRequest")){%> value='DebitCard BlockingRequest' selected <%}else{%> value='DebitCard BlockingRequest' <%}%>  >DebitCard BlockingRequest</option>
						...
						<%} else { %>
							...
							<option  value="DebitCard BlockingRequest" >DebitCard BlockingRequest</option>
		...
		else
		{
			...
			<%
				...
				for(int j=0;j<report.size();j++)
				{
					...
					{
						tempProcessName="DebitCard BlockingRequest";
					}
