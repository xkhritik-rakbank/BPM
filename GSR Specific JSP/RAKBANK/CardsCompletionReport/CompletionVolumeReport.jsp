...
// getting data from request....
	...
	String input6 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("fnl_date_to", request.getParameter("fnl_date_to"), 1000, true) );
	String fnl_date_to = ESAPI.encoder().encodeForSQL(new OracleCodec(), input6!=null?input6:"");
...
String processdefID="";
String param="";
String procName="SRM_CARDS_COMPLETED_REPORT";
...
function generate_Report()
{
	...
	document.FTOReport.action = "CompletionVolumeReport.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
...
function print_Report()
{
	...
	document.FTOReport.action = "CompletionReportPrint.jsp?fnl_date_from="+final_dt_from+"&fnl_date_to="
