...
int count4sum=0;
	...
	WriteLog("Integration jsp: fnl_date_to: "+fnl_date_to);
	...
	WriteLog("Integration jsp: fnl_date_from: "+fnl_date_from);
...
try{
	...
	for(int j=0;j<dcarray.length;j++)   
	{
		...
		*/	 
		...
		+groupName+"'))) AND DRAWING_CODE='"+dcarray[j]+"' GROUP BY DRAWING_CODE,VALUE_DATE,CURRENCY ORDER BY DRAWING_CODE,VALUE_DATE,CURRENCY,SUMAMOUNT";	
