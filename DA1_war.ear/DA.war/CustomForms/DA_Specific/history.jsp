...
//Author                     : Sivakumar-P
// Date written (DD/MM/YYYY) : 29-Jun-2017
...
<style>
	@import url("/DA/webtop/en_us/css/docstyle.css");
</style>
</HEAD>
...
<%	String WINAME=WINAMEEsapi.replace("'","''");
	...
	String hist_table = "usr_0_da_wihistory";
	String colname="";
	String colvalues="'";
	String strQuery="";
	String strInputXML="";
	...
	strQuery="select item_code,Item_Desc from usr_0_da_error_desc_Master with(nolock) where isactive=:isactive order by id asc";
	params = "isactive==Y";
	...
	strQuery="select id,wsname,decision,actiondatetime,remarks,username,rejectreasons from "+hist_table+" where WINAME=:WINAME and actiondatetime is not null order by id desc";		
...
%>
		<tr>
			...
			<td width=28% style="text-align:center;max-width:200px;word-wrap:break-word;word-break: break-all;padding:10px 3px 10px 3px;" class='EWNormalGreenGeneral1'>				
					<b ><%=remarks%></b>				
			</td>
		</tr>
<%
