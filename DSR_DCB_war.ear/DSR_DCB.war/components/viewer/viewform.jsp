    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_RBCommon.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_DCB_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_DCB_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_DCB_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_DCB_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_DCB_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_DCB/CustomJS/DSR_DCB.js?rid=<%= randomId%>"></script>
