    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_RBCommon.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_MR_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_MR_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_MR_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_MR_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_MR_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../CSR_MR/CustomJS/CSR_MR.js?rid=<%= randomId%>"></script>
