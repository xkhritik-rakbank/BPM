...
public class NBTL implements IFormListenerFactory{

	private static String loggerName = "NBTLLogger";
	private static String processName = "NBTL";
	...
	public IFormServerEventHandler getClassInstance(IFormReference iformObj) 
	{
		...
		System.out.println("NBTL Activity Name:"+activityName);	
		return new NBTL_EventHandler();	
	...
	public static void setLogger() 
	{
		try 
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "CustomConfig"+ File.separator+"NBTL"+ File.separator+ "log4j_NBTL.properties"));
