    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL_onLoad.js?rid=<%= randomId%>"></script>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL_onSaveDone.js?rid=<%= randomId%>"></script>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL_RBCommon.js?rid=<%= randomId%>"></script>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL_EventHandler.js?rid=<%= randomId%>"></script>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL_Common.js?rid=<%= randomId%>"></script>
        <script defer type="text/javascript" src="../../GSR_LCOL/CustomJS/GSR_LCOL.js?rid=<%= randomId%>"></script>
