...
window.html2canvas = function(nodeList, options) {
    ...
    return renderDocument(node.ownerDocument, options, node.ownerDocument.defaultView.innerWidth, node.clientHeight, index).then(function(canvas) {
...
NodeParser.prototype.paintText = function(container) {
    ...
    var isuni = hasUnicode(container.node.data);
    if( isuni ){
