    ...
    if( !ApplicationType.equals("pms") && mobileType.equals("mobile") ) {        
        ...
        <link rel="stylesheet" type="text/css" href="resources/slick/slick.css?rid=<%= randomId%>"/>
         ...
         <script type="text/javascript" src="resources/slick/slick.min.js?rid=<%= randomId%>"></script> 
          <%}%>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_RBCommon.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_ODC_onSaveDone.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_ODC_onLoad.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_ODC_MandatoryFieldValidations.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_ODC_EventHandler.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_ODC_Common.js?rid=<%= randomId%>"></script>
		<script defer type="text/javascript" src="../../DSR_ODC/CustomJS/DSR_ODC.js?rid=<%= randomId%>"></script>
