...
String input1 = ESAPI.encoder().encodeForHTML( ESAPI.validator().getValidSafeHTML("htmlInput", request.getParameter("wi_name"), 1000, true) );
	...
	logger.info("In DeleteDeferralData.jsp");
	...
	String sWhere = "WINAME='"+wi_name_Esapi+"'";
	try
	{
		String sInputXML = "";
		String outputXML = ""; 
		String strTableName = "";
		strTableName="USR_0_RBL_Deferral_Grid";
		...
		{	
			...
			logger.info("Output Xml For Delete UID Data-->"+outputXML);
