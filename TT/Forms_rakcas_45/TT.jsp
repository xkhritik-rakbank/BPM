...
function onOPSDataEntryFetchMemo() {
		...
		function initForm(workstepName,sMode)
		{
            ...
            //Added by stutee.mishra
			//ajaxRequest(workstepName,'SelectEnterRemarks');
				...
				if (dialogToOpen=='View Sign')
				{
					...
					if (debt_acc_num!=null && debt_acc_num!='')
					{
						...
						if (window.showModalDialog) {
							...
							popupWindowSign = window.showModalDialog("/webdesktop/CustomForms/TT_Specific/OpenImage.jsp?workstepName="+workstepName+"&signMatchNeededAtChecker="+signMatchNeededAtChecker+"&debt_acc_num="+debt_acc_num,"_blank",sOptions);
								...
								//document.getElementById('signMatchDropDown').value = popupWindow.value;
								popupWindowSign = window.showModalDialog("/webdesktop/CustomForms/TT_Specific/OpenImage.jsp?workstepName="+workstepName+"&debt_acc_num="+debt_acc_num,'_blank',sOptions);
							}
						}else{
							if (workstepName=='Ops_Checker' || workstepName=='Ops_Checker_DB'){
							//openWindow("/webdesktop/CustomForms/TT_Specific/OpenImage.jsp?workstepName="+workstepName+"&signMatchNeededAtChecker="+signMatchNeededAtChecker+"&debt_acc_num="+debt_acc_num,"_blank",sOptions);
							//document.getElementById('wdesk:sign_matchedAtChecker').value = popupWindow.value;
							//document.getElementById('signMatchDropDown').value = popupWindow.value;
							popupWindowSign = window.open("/webdesktop/CustomForms/TT_Specific/OpenImage.jsp?workstepName="+workstepName+"&signMatchNeededAtChecker="+signMatchNeededAtChecker+"&debt_acc_num="+debt_acc_num,"_blank",windowParams);
								...
								//document.getElementById('wdesk:sign_matched').value = popupWindow.value;
								//document.getElementById('signMatchDropDown').value = popupWindow.value;
								popupWindowSign = window.open("/webdesktop/CustomForms/TT_Specific/OpenImage.jsp?workstepName="+workstepName+"&debt_acc_num="+debt_acc_num,'_blank',windowParams);
							}
