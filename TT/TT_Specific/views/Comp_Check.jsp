		...
		<div id="panel1" class="accordion-body collapse">
			<div class="accordion-inner">
				<table border='2' cellspacing='1' cellpadding='0' width=100%>
					...
					<tr width=100%>
						<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
							<button id="view_raise_excep"  class='EWButtonRB' onclick="openCustomDialog('Exception History','<%=workstepName%>');">View/Raise Exceptions</button>
						</td>
			...
			<div class="accordion-inner">
				<table border='1' cellspacing='1' cellpadding='0' width=100%>									
						...
						<tr width=100%>
							...
							<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
								<input type="text" disabled name="wdesk:beneficiaryCity" id="wdesk:beneficiaryCity" value='<%=((WorkdeskAttribute)attributeMap.get("beneficiaryCity")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("beneficiaryCity")).getValue()%>' maxlength = '35'>
							</td>
