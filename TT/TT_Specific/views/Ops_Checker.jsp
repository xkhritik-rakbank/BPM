...
<div class="accordion" id="accordion1" class="accordion-group">
			...
			<div class="accordion-inner" >
				 <table border='1' cellspacing='1' cellpadding='0' width=100%>									
					...
					<tr width=100%>
						...
						<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
							<input type="text" <%=strDisableReadOnly%>  disabled name="wdesk:call_back_atmpt_made" id="wdesk:call_back_atmpt_made" value='<%=((WorkdeskAttribute)attributeMap.get("callBackAtmptMadeCount")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callBackAtmptMadeCount")).getValue()%>' >
						</td>
						<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'></td>
						<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
						</td>
	...
	<input type="hidden" name="wdesk:opsCheckerUser" id="wdesk:opsCheckerUser" value='<%=((WorkdeskAttribute)attributeMap.get("opsCheckerUser")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("opsCheckerUser")).getValue()%>'>
</div>	