						...
						<div class="accordion-inner">
							...
							<td class='EWNormalGreenGeneral1 width25'>
								...
								<tr width=100%>
									...
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<input type="button" class='EWButtonRB' id="view_raise_excep" onclick="openCustomDialog('Exception History','<%=workstepName%>');" value="View/Raise Exceptions">
									</td>										
								</tr>																
							</table>								
						</div>
					...
					<div id="panel2" class="accordion-body collapse">
						<div class="accordion-inner">
							<table border='1' cellspacing='1' cellpadding='0' width=100% >							
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Transfer Amount</td>
									<td width="30%" colspan="2"  nowrap='nowrap' class='EWNormalGreenGeneral1'>
									...
									<td width="41%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Charges&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>FX Rate</td>
									<td width="30%" colspan="2" nowrap='nowrap' class='EWNormalGreenGeneral1'>
									...
									<td width="41%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Preferential Rate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Remittance Amount</td>
									<td width="30%" colspan="2" nowrap='nowrap' class='EWNormalGreenGeneral1'>
									...
									<td width="41%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Deal Reference Code&nbsp;
								...
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Amount Debited From Account</td>
									<td width="30%" colspan="2" nowrap='nowrap' class='EWNormalGreenGeneral1'>
									...
									<td width="41%" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
								</tr>
								<tr width=100%>
