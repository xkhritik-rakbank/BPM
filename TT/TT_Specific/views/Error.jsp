...
<div class="accordion" id="accordion1" class="accordion-group">
	<div class="accordion-group">
							...
							<td class='EWNormalGreenGeneral1 width25'>
								...
								<tr width=100%>
									...
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1' id="viewsignatureB">
										<input type="button" <%=strDisableReadOnly%> disabled class='EWButtonRB' id="view_sign" onclick="openCustomDialog('View Sign','<%=workstepName%>');" value="View Signatures">
									</td>
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<input type="button" <%=strDisableReadOnly%> class='EWButtonRB' id="view_raise_excep" onclick="openCustomDialog('Exception History','<%=workstepName%>');" value="View/Raise Exceptions">
									</td>										
								</tr>																
							</table>								
						</div>
		...
		<div class="accordion-group">
                ...
                <div class="accordion-inner">
                    <table border='1' cellspacing='1' cellpadding='0' width=100% > 
						<tr width=100%>
							...
							<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
								<!--input type="text" name="wdesk:benefBankCntry" id="wdesk:benefBankCntry" disabled value='<!--%=((WorkdeskAttribute)attributeMap.get("benefBankCntry")).getValue()
								==null?"":((WorkdeskAttribute)attributeMap.get("benefBankCntry")).getValue()%>'-->
						...
						<tr width=100% id="benbankbranch">
							...
							<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
								<input type="text" <%=strDisableReadOnly%>  disabled name="wdesk:BenfcityState" id="wdesk:BenfcityState" value='<%=((WorkdeskAttribute)attributeMap.get("benefBankBranch")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("benefBankBranch")).getValue()%>' maxlength = '35'>
							</td>
						...
						<tr width=100%>
							...
							<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
								<input type="text" <%=strDisableReadOnly%> disabled name="wdesk:actualcode" id="wdesk:actualcode" value='<%=((WorkdeskAttribute)attributeMap.get("benefActualCode")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("benefActualCode")).getValue()%>' maxlength = '30'>
							</td>
							<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'></td>						
						</tr>	
					</table>
						...
						<div class="accordion-inner">
							<table border='1' cellspacing='1' cellpadding='0' width=100% >									
									<tr width=100%>
										...
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<!--input type="text" disabled name="wdesk:interBankCntry" id="wdesk:interBankCntry" value=''-->
						...
						<div class="accordion-inner" >
							 <table border='1' cellspacing='1' cellpadding='0' width=100%>									
								<tr width=100% >
									...
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<input type="text" <%=strDisableReadOnly%>  disabled name="wdesk:callBackSuccess" id="wdesk:callBackSuccess"  value='<%=((WorkdeskAttribute)attributeMap.get("callBackSuccess")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callBackSuccess")).getValue()%>' >
									</td>									
								</tr>
								<tr width=100%>
			...
			<div class="accordion-heading">
				<h4 class="panel-title" style="color:white;>
					<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#panel10">
						<b>Error Details</b>
					</a>
				</h4>
			</div>
			<div id="panel10" class="accordion-body collapse">
				<div class="accordion-inner">
					<table border='1' cellspacing='1' cellpadding='0' width=100% >									
						<tr width=100%>
							<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Failed Integration Call</td>
							<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
								<input type="text" disabled name="wdesk:failedIntegrationCall" id="wdesk:failedIntegrationCall" value='<%=((WorkdeskAttribute)attributeMap.get("failedIntegrationCall")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("failedIntegrationCall")).getValue()%>' maxlength = '35'>
							</td>
							<td width="50%" nowrap='nowrap' colspan="2" class='EWNormalGreenGeneral1'>&nbsp;</td>
						</tr>
						<tr width=100%>
							<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Error Message/Description from Finacle</td>
							<td width="71%" nowrap='nowrap' colspan="3" class='EWNormalGreenGeneral1'>
								<textarea <%=strDisableReadOnly%>  style="width:100%" disabled name="wdesk:errorMsgFromFinacle" rows="3" cols="33" maxlength="100" onkeypress="if (this.value.length > 100) { return false; }" id="wdesk:custAddress"><%=((WorkdeskAttribute)attributeMap.get("errorMsgFromFinacle")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("errorMsgFromFinacle")).getValue()%></textarea>
							</td>
						</tr>
					</table>
				</div>
	...
	<input type="hidden" name="wdesk:benefCityState" id="wdesk:benefCityState" value='<%=((WorkdeskAttribute)attributeMap.get("benefCityState")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("benefCityState")).getValue()%>'>
	<input type="hidden" name="wdesk:trans_code" id="wdesk:trans_code" value='<%=((WorkdeskAttribute)attributeMap.get("trans_code")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("trans_code")).getValue()%>'>
	<input type="hidden" name="wdesk:comp_req" id="wdesk:comp_req" value='<%=((WorkdeskAttribute)attributeMap.get("comp_req")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("comp_req")).getValue()%>'>
