								...
								<table border='2' cellspacing='1' cellpadding='0' width=100%>
									...
									<tr width=100% id="callbackCompliance">
										...
										<td id="callbackrequiredF" width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<input type="text" name="wdesk:callbackFlgFinacle" disabled id="wdesk:callbackFlgFinacle" value='<%=((WorkdeskAttribute)attributeMap.get("callbackFlgFinacle")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callbackFlgFinacle")).getValue()%>' >
									...
									<tr width=100%>
										<td id="compliancecheckL" width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Compliance Check Required
										</td>
										<td id="compliancecheckF" width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											...
											<input type="text" name="wdesk:referCtryFlgFinacle" disabled id="wdesk:referCtryFlgFinacle" value='<%=((WorkdeskAttribute)attributeMap.get("referCtryFlgFinacle")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("referCtryFlgFinacle")).getValue()%>' >
										</td>
							...
							<td class='EWNormalGreenGeneral1 width25'>
								...
								<input type="text" disabled name="wdesk:authorized_sign" id="wdesk:authorized_sign" value='<%=((WorkdeskAttribute)attributeMap.get("authorized_sign")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("authorized_sign")).getValue()%>'> 
									...
									<tr width=100%>
										...
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<input type="button" <%=strDisableReadOnly%>  disabled class='EWButtonRB' onclick="accountBalanceDetails();" id="getAccBalance" value="Get Account Balance">
										</td>
										<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1' id="viewsignatureB">
											<input type="button" <%=strDisableReadOnly%>  class='EWButtonRB' id="view_sign" onclick="openCustomDialog('View Sign','<%=workstepName%>');" value="View Signatures">
										</td>		
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
								 ...
								 <table border='1' cellspacing='1' cellpadding='0' width=100%>									
									...
									<tr width=100%>
										...
										<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											...
											<!--This field is already present-->
											<!--input type="hidden" name="wdesk:callBackSuccess" id="wdesk:callBackSuccess"  -->
											<input  type="hidden" <%=strDisableReadOnly%> name="wdesk:complaince_sucess" id="wdesk:complaince_sucess"  value='<%=((WorkdeskAttribute)attributeMap.get("complaince_sucess")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("complaince_sucess")).getValue()%>' >
										</td>
									</tr>
