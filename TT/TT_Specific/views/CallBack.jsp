					...
					<div id="panel1" class="accordion-body collapse">
						<div class="accordion-inner">
							<table border='2' cellspacing='1' cellpadding='0' width=100%>
								<tr width=100%>
									<td width="29%" nowrap='nowrap' id="paymentorderidL" class='EWNormalGreenGeneral1' nowrap='nowrap' class='EWNormalGreenGeneral1'>
										Payment Order Id
									</td>
									<td width="29%" style="display:none;" id="paymentorderidLB"  nowrap='nowrap' class='EWNormalGreenGeneral1'>
										&nbsp;
									</td>
									...
									<td width="21%" nowrap='nowrap' id="paymentorderidFB" class='EWNormalGreenGeneral1' style="display:none;"></td>
								...
								<tr width=100%>
									...
									<td nowrap='nowrap' class='EWNormalGreenGeneral1' id="cutofftimeF">
										<input type="text" <%=strDisableReadOnly%>  disabled name="wdesk:cut_off_time" id="wdesk:cut_off_time" value='<%=((WorkdeskAttribute)attributeMap.get("cut_off_time")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("cut_off_time")).getValue()%>'>
									</td>
									<td nowrap='nowrap' class='EWNormalGreenGeneral1'>Customer Name
									</td>
								...
								<tr width=100%>
									...
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										...
										<input type="hidden" name="wdesk:cust_type" id="wdesk:cust_type" value='<%=((WorkdeskAttribute)attributeMap.get("cust_type")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("cust_type")).getValue()%>' maxlength = '100'>
									</td>
								</tr>
								<tr width=100%>
							...
							<td class='EWNormalGreenGeneral1 width25'>
								...
								<input type="text" disabled name="wdesk:authorized_sign" id="wdesk:authorized_sign" value='<%=((WorkdeskAttribute)attributeMap.get("authorized_sign")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("authorized_sign")).getValue()%>'> 
									...
									<tr width=100%>
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<input type="button" <%=strDisableReadOnly%>  class='EWButtonRB' name="wdesk:view_raise_excep" id="view_raise_excep" onclick="openCustomDialog('Exception History','<%=workstepName%>');" value="View/Raise Exceptions">
										</td>
										<td width="71%" colspan="3" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>										
									</tr>
							</table>								
						</div>
					</div>
						...
						<div class="accordion-inner">
							<table border='1' cellspacing='1' cellpadding='0' width=100% >							
								...
								<tr width=100%>
									...
									value='<%=((WorkdeskAttribute)attributeMap.get("purp_of_payment2")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("purp_of_payment2")).getValue()%>' maxlength="32"><br/>
									<input type="text" disabled style="width: 60%;" name="wdesk:purp_of_payment3" id="wdesk:purp_of_payment3" maxlength="32"
									value='<%=((WorkdeskAttribute)attributeMap.get("purp_of_payment3")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("purp_of_payment3")).getValue()%>' maxlength="32"><br/>
									</td>
								</tr>
							</table>
						</div>
						...
						<div class="accordion-inner">
							<table border='1' cellspacing='1' cellpadding='0' width=100% >									
								<tr width=100%>
									...
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>										
										<select <%=strHideReadOnly%> <%=strDisableReadOnly%>  style="width:139px;display:none" id="wdesk:interBankCntryCombo" name="wdesk:interBankCntryCombo" onchange="setComboValueToTextBox(this,'wdesk:interBankCntry')">
											<option value="--Select--">--Select--</option>													
										</select>
				...
				<div class="accordion-group" id="callbackaccordion">
					...
					<div id="panel5" class="accordion-body collapse">
						<div class="accordion-inner" >
							 <table border='1' cellspacing='1' cellpadding='0' width=100%>									
								<tr width=100% >
									<td  width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Call Back Required
										<label class="mandatory" id="CallBackReqM">&nbsp;*</label>
									</td>
									<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
									...
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Call Back Successful
										<label class="mandatory">&nbsp;*</label>
									</td>
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<input disabled type="text" <%=strDisableReadOnly%> name="wdesk:callBackSuccess" id="wdesk:callBackSuccess"  value='<%=((WorkdeskAttribute)attributeMap.get("callBackSuccess")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callBackSuccess")).getValue()%>' >
									</td>									
								</tr>
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Prospect Number
										<label class="mandatory">&nbsp;*</label>
									</td>
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<input type="text" <%=strDisableReadOnly%>   name="wdesk:prospect_Num" id="wdesk:prospect_Num" maxlength="8" value='<%=((WorkdeskAttribute)attributeMap.get("prospect_Num")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("prospect_Num")).getValue()%>'>
									</td>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Customer Language</td>
									<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<select <%=strHideReadOnly%> <%=strDisableReadOnly%>  style="WIDTH: 148px;" id="custLanguage" onchange="setComboValueToTextBox(this,'wdesk:custLang')">
												<option value="--Select--">--Select--</option>
											</select>
										<input type="hidden" name="wdesk:custLang" id="wdesk:custLang" value='<%=((WorkdeskAttribute)attributeMap.get("custLang")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("custLang")).getValue()%>'>
									</td>
								</tr>
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Call Back Customer Verification
										<label class="mandatory" id="CallBackReqM">&nbsp;*</label>
									</td>
									<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<select <%=strHideReadOnly%> <%=strDisableReadOnly%>  style="width:100%" id="dropDownCallBackCustVerf" onchange="setComboValueToTextBox(this,'wdesk:custCallBackVer'),CustVerifDrpDwnHandler(this)">
											<option value="--Select--">--Select--</option>
										</select>
										<input type="hidden" <%=strDisableReadOnly%>   name="wdesk:custCallBackVer" id="wdesk:custCallBackVer" value='<%=((WorkdeskAttribute)attributeMap.get("custCallBackVer")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("custCallBackVer")).getValue()%>'>
									</td>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Call Back Failure Reason</td>
									<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<select <%=strHideReadOnly%> <%=strDisableReadOnly%>  style="WIDTH: 148px;" id="dropDownCallBackFailureReason" onchange="setComboValueToTextBox(this,'wdesk:custCallBackFailReason')">
											<option value="--Select--">--Select--</option>
										</select>
										<input type="hidden" <%=strDisableReadOnly%>   name="wdesk:custCallBackFailReason" id="wdesk:custCallBackFailReason" value='<%=((WorkdeskAttribute)attributeMap.get("custCallBackFailReason")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("custCallBackFailReason")).getValue()%>'>
									</td>
								</tr>
								<tr width=100%>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>Call back attempt made</td>
									<td  width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
										<input type="text" disabled name="wdesk:callBackAtmptMadeCount" id="wdesk:callBackAtmptMadeCount" value='<%=((WorkdeskAttribute)attributeMap.get("callBackAtmptMadeCount")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callBackAtmptMadeCount")).getValue()%>'>
										<input type="hidden" name="wdesk:callbackAttemptsPrev" id="wdesk:callbackAttemptsPrev" value='<%=((WorkdeskAttribute)attributeMap.get("callbackAttemptsPrev")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callbackAttemptsPrev")).getValue()%>'>
									</td>
									<td width="29%" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
									<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
								</tr>								
								<tr width=100% id="callbackattempt1">
										...
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<select <%=strHideReadOnly%> <%=strDisableReadOnly%>  style="width:100%" id="call_back_success1" onchange="callBackDrpDwnHandler(this,'<%=workstepName%>'),setComboValueToTextBox(this,'wdesk:attempt1')">
												<option value="--Select--">--Select--</option>
												<option value="Yes">Yes</option>
												<option value="No">No</option>
											</select>
											<input type="hidden" disabled name="wdesk:attempt1" id="wdesk:attempt1" value='<%=((WorkdeskAttribute)attributeMap.get("attempt1")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("attempt1")).getValue()%>'>
										</td>									
									...
									<tr width=100% id="callbackattempt2">
										...
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<select <%=strHideReadOnly%>  style="width:100%" id="call_back_success2" onchange="callBackDrpDwnHandler(this,'<%=workstepName%>'),setComboValueToTextBox(this,'wdesk:attempt2')">
												<option value="--Select--">--Select--</option>
												<option value="Yes">Yes</option>
												<option value="No">No</option>												
											</select>
											<input type="hidden"  name="wdesk:attempt2" id="wdesk:attempt2" value='<%=((WorkdeskAttribute)attributeMap.get("attempt2")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("attempt2")).getValue()%>'>
										</td>
										<td colspan="2" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
									</tr>
									<tr width=100% id="callbackattempt3">
										...
										<td width="21%" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<select <%=strHideReadOnly%> <%=strDisableReadOnly%>  style="width:100%" id="call_back_success3" onchange="callBackDrpDwnHandler(this,'	<%=workstepName%>'),setComboValueToTextBox(this,'wdesk:attempt3')">
												<option value="--Select--">--Select--</option>
												<option value="Yes">Yes</option>
												<option value="No">No</option>
											</select>											
											<input type="hidden" name="wdesk:attempt3" id="wdesk:attempt3" value='<%=((WorkdeskAttribute)attributeMap.get("attempt3")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("attempt3")).getValue()%>'>
										</td>
										<td colspan="2" nowrap='nowrap' class='EWNormalGreenGeneral1'>&nbsp;</td>
									<tr width=100%>
										...
										<td colspan="3" nowrap='nowrap' class='EWNormalGreenGeneral1'>
											<textarea style="width:100%" disabled name="wdesk:callbackwaiver" id="wdesk:callbackwaiver" rows="6" cols="50" maxlength = '1000' onkeypress="if (this.value.length > 1000) { return false; }"><%=((WorkdeskAttribute)attributeMap.get("callbackwaiver")).getValue()==null?"":((WorkdeskAttribute)attributeMap.get("callbackwaiver")).getValue()%></textarea>
										</td>
									</tr>
